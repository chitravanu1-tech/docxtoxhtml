...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:template match="CharacterStyleRange[not(ancestor::Note)]">
...
<!--                        <xsl:variable name="matches" select="mf:extract(.,'[\p{Zs}\t]')"/>-->
        ...
        <xsl:choose>
            <xsl:when test="not($delimiter)">
                ...
                <xsl:element name="CharacterStyleRange">
                   ...
                   <!-- <xsl:for-each select="ancestor::CharacterStyleRange[1]/*">
                    ...
                    <xsl:copy-of select="ancestor::CharacterStyleRange[1]/@*"/>
                    <xsl:copy-of select="ancestor::CharacterStyleRange[1]/Properties"/>
                    <xsl:copy-of select="ancestor::CharacterStyleRange[1]/FormattingChange"/>
            ...
            <xsl:when test="contains($string, $delimiter)">
                ...
                <xsl:element name="CharacterStyleRange">
                    ...
                    <xsl:attribute name="WordNumber" select="$delimitterName"/>
    ...
    <xsl:template match="Footnote">
        <xsl:variable name="parChar" select="ancestor::CharacterStyleRange[1]"/>
        <xsl:choose>
            <xsl:when test="ancestor::CharacterStyleRange[1][descendant::Content[ancestor::CharacterStyleRange[1] =$parChar]]">

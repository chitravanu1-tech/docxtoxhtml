...
<!--    <xsl:template match="w:p[child::w:pPr/child::w:rPr/child::w:del and not(child::w:r)]">
        
        <xsl:call-template name="mergePara"/>
    </xsl:template>-->
    ...
    <xsl:template match="w:p[(child::w:pPr/child::w:rPr/child::w:del and not(child::w:r | child::w:ins))]"/>
    
    <xsl:template match="w:p[child::w:pPr/child::w:rPr/child::w:del and (child::w:r|child::w:ins)]">
        <xsl:copy>
            <xsl:apply-templates select="@*|node()"/>
            <xsl:for-each select="following-sibling::w:p[1]">
                <!--<xsl:apply-templates select="* except w:pPr"/>-->
                <xsl:call-template name="followingPara"/>
            </xsl:for-each>
        </xsl:copy>
    </xsl:template>
    
    <xsl:template name="followingPara">
        <xsl:apply-templates select="* except w:pPr"/>
        <xsl:if test="child::w:pPr/child::w:rPr/child::w:del">
        <xsl:for-each select="following-sibling::w:p[1]">
            <xsl:call-template name="followingPara"/>
        </xsl:for-each>
        </xsl:if>
...
<!--    <xsl:template match="w:p[(preceding-sibling::w:p[1][child::w:pPr/child::w:rPr/child::w:del and child::w:r]) or ((child::w:pPr/child::w:rPr/child::w:del and child::w:r) and (preceding-sibling::w:p[1][child::w:pPr/child::w:rPr/child::w:del]))]">-->
<!--        <xsl:template match="w:p[(preceding-sibling::w:p[1][child::w:pPr/child::w:rPr/child::w:del])]">-->
    <xsl:template match="w:p[(preceding-sibling::w:p[1][child::w:pPr/child::w:rPr/child::w:del  and (child::w:r|child::w:ins)])]">
        <xsl:choose>
            <xsl:when test="(preceding-sibling::w:p[1][child::w:pPr/child::w:rPr/child::w:del and (child::w:r|child::w:ins)])"/>
            <xsl:when test="(preceding-sibling::w:p[1][child::w:pPr/child::w:rPr/child::w:del and not(child::w:r| child::w:ins)])">
                <xsl:variable name="isPrecedingMerge">
                    <xsl:for-each select="preceding-sibling::w:p[1][child::w:pPr/child::w:rPr/child::w:del and not(child::w:r|child::w:ins)]">
                        <xsl:call-template name="precedingPara"/>
                    </xsl:for-each>
                </xsl:variable>
                <xsl:if test="$isPrecedingMerge ='false'">
                    <xsl:copy>
                        <xsl:apply-templates select="@*|node()"/>
                    </xsl:copy>
                </xsl:if>
    ...
    <xsl:template name="precedingPara">
        <xsl:if test="(child::w:pPr/child::w:rPr/child::w:del and (child::w:r|child::w:ins))">
            <xsl:value-of select="'true'"/>
        </xsl:if>
        <xsl:if test="not(child::w:pPr/child::w:rPr/child::w:del)">
            <xsl:value-of select="'false'"/>
        </xsl:if>
        <xsl:if test="child::w:pPr/child::w:rPr/child::w:del and not(child::w:r|child::w:ins)">

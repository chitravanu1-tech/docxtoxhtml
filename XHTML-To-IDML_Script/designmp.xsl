...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:variable name="index" select="document('xhtmltoXML_out.xml')"/>
    <xsl:variable name="Hyper" select="document('document_out4.xml')"/>
    ...
    <xsl:template match="Document">
        ...
        <xsl:copy>
            <xsl:copy-of select="@*"/>
            <!--<xsl:if test="not(descendant::Condition[@Name='AuthorQuery'])">
<Condition Self="Condition/AuthorQuery" Name="AuthorQuery" IndicatorMethod="UseHighlight" UnderlineIndicatorAppearance="Wavy" Visible="true">
		<Properties>
			<IndicatorColor type="enumeration">Cyan</IndicatorColor>
		</Properties>
	</Condition>
	</xsl:if>
			<xsl:if test="not(descendant::Condition[@Name='Condition 1_AuthorQuery'])">
<Condition Self="Condition/Condition 1_AuthorQuery" Name="Condition 1_AuthorQuery" IndicatorMethod="UseHighlight" UnderlineIndicatorAppearance="Wavy" Visible="true">
		<Properties>
			<IndicatorColor type="enumeration">Cyan</IndicatorColor>
		</Properties>
	</Condition>
	</xsl:if>-->
            <xsl:if test="not(descendant::Condition[@Name = 'Comments'])">
                <Condition Self="Condition/Comments" Name="Comments" IndicatorMethod="UseUnderline"
                    UnderlineIndicatorAppearance="Dashed" Visible="true">
                    <Properties>
                        <IndicatorColor type="enumeration">LightBlue</IndicatorColor>
                    </Properties>
                </Condition>
            </xsl:if>
            <xsl:if test="not(descendant::Condition[@Name = 'FieldCodeChar'])">
                <Condition Self="Condition/FieldCodeChar" Name="FieldCodeChar"
                    IndicatorMethod="UseUnderline" UnderlineIndicatorAppearance="Dashed"
                    Visible="true">
                    <Properties>
                        <IndicatorColor type="enumeration">LightBlue</IndicatorColor>
                    </Properties>
            ...
            <xsl:if test="not(descendant::Condition[@Name = 'Condition 1'])">
                <Condition Self="Condition/Condition 1" Name="Condition 1"
                    IndicatorMethod="UseHighlight" UnderlineIndicatorAppearance="Wavy"
                    Visible="true">
                    <Properties>
                        <IndicatorColor type="enumeration">GridBlue</IndicatorColor>
                    </Properties>
                </Condition>
            </xsl:if>

            <xsl:if test="not(descendant::Condition[@Name = 'CrossRefCondition'])">
                <Condition Self="Condition/CrossRefCondition" Name="CrossRefCondition"
                    IndicatorMethod="UseHighlight" UnderlineIndicatorAppearance="Wavy"
                    Visible="true">
                    <Properties>
            ...
            <!--For MisMatchStyle {16.02.2017}-->
            <xsl:if test="not(descendant::Condition[@Name = 'MisMatchStyle'])">
                <Condition Self="Condition/MisMatchStyle" Name="MisMatchStyle"
                    IndicatorMethod="UseHighlight" UnderlineIndicatorAppearance="Wavy"
                    Visible="true">
                    <Properties>
                        <IndicatorColor type="enumeration">Yellow</IndicatorColor>
                    </Properties>
                </Condition>
            </xsl:if>

            <xsl:if test="$Hyper//CharacterStyleRange[contains(@AppliedConditions,'Condition/BibRef')]">
                <xsl:for-each select="$Hyper//CharacterStyleRange[contains(@AppliedConditions,'Condition/BibRef')]">
                    <xsl:variable name="val"><xsl:value-of select="self::CharacterStyleRange[contains(@AppliedConditions,'Condition/BibRef')]/substring-after(@AppliedConditions,'Condition/')"/></xsl:variable>
                    <Condition Self="Condition/{$val}" Name="{$val}"
                        IndicatorMethod="UseHighlight" UnderlineIndicatorAppearance="Wavy"
                        Visible="true">
                        <Properties>
                            <IndicatorColor type="enumeration">Yellow</IndicatorColor>
            ...
            <!--			<xsl:element name="Index">
				...
				<xsl:for-each select="$index//PageReference">
					<xsl:variable name="pageref" select="@ReferencedTopic"/>
					<xsl:element name="Topic">
						<xsl:attribute name="Self" select="$pageref"/>
						<xsl:attribute name="SortOrder" select="''"/>
						<xsl:attribute name="Name" select="substring-after($pageref, 'Topicn')"/>
					</xsl:element>
				</xsl:for-each>
			</xsl:element>-->
            ...
            <xsl:element name="Index">
                <xsl:attribute name="Self" select="'di2'"/>
                <xsl:for-each select="$index//p//span[@class='Main' or matches(@class,'Sub([0-9]+)')]">
                    <!--Level 1-->
                    <xsl:if test="self::span[@class='Main']">
                        <xsl:variable name="index1" select="./text()"/>
                        ...
                        <xsl:element name="Topic">
                                                                                        ...
                                                                                        <xsl:element name="Topic">
                                                                                            ...
                                                                                            <xsl:for-each select="//span[matches(@class,'Sub([0-9]+)')][concat($data-id9,@class)=@data-mark]">
                                                                                                ...
                                                                                                <xsl:element name="Topic">
                                                                                                    ...
                                                                                                    <xsl:attribute name="SortOrder" select="''"/>
                                                                                                    <xsl:attribute name="Name"
                                                                                                        select="normalize-space($index10)"/>
                                                                                                    ...
                                                                                                    <xsl:for-each select="//span[matches(@class,'Sub([0-9]+)')][concat($data-id10,@class)=@data-mark]">
                                                                                                        ...
                                                                                                        <xsl:element name="Topic">
                                                                                                            ...
                                                                                                            <xsl:attribute name="SortOrder" select="''"/>
                                                                                                            <xsl:attribute name="Name"
                                                                                                                select="normalize-space($index11)"/>
                                                                                                            ...
                                                                                                            <xsl:for-each select="//span[matches(@class,'Sub([0-9]+)')][concat($data-id11,@class)=@data-mark]">
                                                                                                                ...
                                                                                                                <xsl:element name="Topic">
                                                                                                                    ...
                                                                                                                    <xsl:attribute name="SortOrder" select="''"/>
                                                                                                                    <xsl:attribute name="Name"
                                                                                                                        select="normalize-space($index12)"/>
                                                                                                                    ...
                                                                                                                    <xsl:for-each select="//span[matches(@class,'Sub([0-9]+)')][concat($data-id12,@class)=@data-mark]">
                                                                                                                        ...
                                                                                                                        <xsl:element name="Topic">
                                                                                                                            ...
                                                                                                                            <xsl:attribute name="SortOrder" select="''"/>
                                                                                                                            <xsl:attribute name="Name"
                                                                                                                                select="normalize-space($index13)"/>
                                                                                                                            ...
                                                                                                                            <xsl:for-each select="//span[matches(@class,'Sub([0-9]+)')][concat($data-id13,@class)=@data-mark]">
                                                                                                                                ...
                                                                                                                                <xsl:element name="Topic">
                                                                                                                                    ...
                                                                                                                                    <xsl:attribute name="SortOrder" select="''"/>
                                                                                                                                    <xsl:attribute name="Name"
                                                                                                                                        select="normalize-space($index14)"/>
                                                                                                                                    ...
                                                                                                                                    <xsl:for-each select="//span[matches(@class,'Sub([0-9]+)')][concat($data-id14,@class)=@data-mark]">
                                                                                                                                        ...
                                                                                                                                        <xsl:element name="Topic">
                                                                                                                                            ...
                                                                                                                                            <xsl:attribute name="SortOrder" select="''"/>
                                                                                                                                            <xsl:attribute name="Name"
                                                                                                                                                select="normalize-space($index15)"/>
                            ...
                            <!--Added for duplicate main on 06-04-2021-->
            ...
            <!--<xsl:element name="Index">
                <xsl:attribute name="Self" select="'di2'"/>
                <xsl:for-each select="$index/root/div">
                    <xsl:variable name="index1" select="p[@class = 'index1']"/>
                    ...
                    <xsl:element name="Topic">
                        ...
                        <xsl:attribute name="Name" select="$index1"/>
                        <!-\- Level 2 -\->
                        <xsl:if test="$strlen2 > 2">
                            <xsl:element name="Topic">
                                ...
                                <xsl:attribute name="Name" select="$index2"/>
                                <!-\- Level 3 -\->
    ...
    <xsl:template match="idPkg:BackingStory"> 
        ...
        <!--for Hyperlink 19-6-2019-->
        <xsl:if test="$Hyper//HyperlinkTextSource">
            <xsl:for-each select="$Hyper//HyperlinkTextSource">
                <xsl:element name="HyperlinkURLDestination">
                    <xsl:attribute name="Self">
                        <xsl:variable name="hyper" select="child::HyperLink-Text"/>
                        <xsl:value-of select="'HyperlinkURLDestination/'"/>
                            <xsl:choose>
                            <xsl:when test="contains($hyper,':')">
                                <xsl:value-of select="replace($hyper,':','%3a')"/>
                                </xsl:when>
                            <xsl:otherwise>
                                <xsl:value-of select="$hyper"/>
                                </xsl:otherwise>
                        </xsl:choose>
                           </xsl:attribute>
                    <xsl:attribute name="Name">
                        <xsl:value-of select="child::HyperLink-Text"/>
                     </xsl:attribute>
                    <xsl:attribute name="DestinationURL">
                        <xsl:value-of select="child::HyperLink-Text"/>
                    </xsl:attribute>
                    ...
                    <xsl:attribute name="DestinationUniqueKey">
                        <xsl:value-of select="'7777'"/>
            ...
            <xsl:for-each select="$Hyper//HyperlinkTextSource">
                <xsl:element name="Hyperlink">
                    <xsl:attribute name="Self">
                        ...
                        <xsl:value-of select="concat('uu', $num, 'f')"/>
                    </xsl:attribute>
                    <xsl:attribute name="Name">
                    ...
                    <xsl:element name="Properties">
                        ...
                        <xsl:element name="Destination">
                            ...
                            <xsl:value-of select="'HyperlinkURLDestination/'"/>
                            <xsl:variable name="hyptext">
                                <xsl:value-of select="HyperLink-Text"/>
                            </xsl:variable>
                                                      
                            <xsl:choose>
                                    <xsl:when test="contains($hyptext,':')">
                                        <xsl:value-of select="replace($hyptext,':','%3a')"/>
                                </xsl:when>
                                <xsl:otherwise>
                                    <xsl:value-of select="$hyptext"/>
                                </xsl:otherwise>
                            </xsl:choose>
                            </xsl:element>
                    </xsl:element>
        ...
        <!--<xsl:for-each select="$Hyper//HyperlinkTextSource">
                                <xsl:element name="Bookmark">
                                    ...
                                    <xsl:attribute name="Destination">
                                        <xsl:value-of select="'HyperlinkTextDestination/'"/>
                                        <xsl:value-of select="@Self"/>
                                    </xsl:attribute>
                                    </xsl:element>
                            </xsl:for-each>-->

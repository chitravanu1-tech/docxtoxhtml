...
<xsl:output method="xml" omit-xml-declaration="no" indent="no" cdata-section-elements="alt"/>
     ...
     <xsl:template match="GROUP">
           ...
           <xsl:choose>
                 <xsl:when test="following-sibling::*[1][self::GROUP/@type]">
                       <xsl:copy>
                             <xsl:copy-of select="child::*[1][self::RSID/@*]"/>
                             <xsl:apply-templates select="@*|node()"/>                                          
                       </xsl:copy> 
                 </xsl:when>
                 <xsl:when test="following-sibling::*[1][self::GROUP]">
                       <xsl:choose>
                             <xsl:when test="child::oneX">
                             ...
                             <xsl:when test="child::twoX">
                                   ...
                                   <xsl:choose>
                                         ...
                                         <!--<xsl:when test="following-sibling::*[1][p]">
                                               <xsl:text disable-output-escaping="yes">&lt;/GROUPx&gt;</xsl:text>
                                               <xsl:text disable-output-escaping="yes">&lt;/GROUPx&gt;</xsl:text>
                                               <xsl:text>&#x000A;</xsl:text>
                                         </xsl:when>-->
                                         <xsl:otherwise/>
                             ...
                             <xsl:when test="not(following-sibling::*[1][self::GROUP])">
                                   <xsl:choose>
                                         ...
                                         <xsl:when test="child::five">
                                               ...
                                               <xsl:text disable-output-escaping="yes">&lt;/GROUPxx&gt;</xsl:text>
                                               <xsl:text disable-output-escaping="yes">&lt;/GROUP&gt;</xsl:text>
                                               <xsl:text disable-output-escaping="yes">&lt;/GROUP&gt;</xsl:text>
                                               <xsl:text disable-output-escaping="yes">&lt;/GROUP&gt;</xsl:text>
                                         </xsl:when>
                 ...
                 <xsl:when test="preceding-sibling::*[1][self::GROUP] and following-sibling::*[1][self::GROUP]">   
                       <xsl:choose>
                             ...
                             <xsl:when test="following-sibling::*[1][self::GROUP/two[@numberType != child::*[1][self::two/@numberType]]]">
                                   <xsl:text disable-output-escaping="yes">&lt;/GROUPy&gt;</xsl:text>
                                   <xsl:text disable-output-escaping="yes">&lt;/GROUPy&gt;</xsl:text>
                             </xsl:when>
                             <xsl:when test="child::*[1][self::one] and preceding-sibling::*[1][self::GROUP/one]">
                                   <xsl:text disable-output-escaping="yes">&lt;/GROUPz&gt;</xsl:text>
                                   <xsl:text disable-output-escaping="yes">&lt;/GROUPz&gt;</xsl:text>
                             </xsl:when>
                       </xsl:choose>
                 </xsl:when>

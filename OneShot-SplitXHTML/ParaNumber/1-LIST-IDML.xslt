...
<xsl:output method="xml" omit-xml-declaration="no" indent="no" cdata-section-elements="alt"/>
      ...
      <xsl:template match="one">     
            <xsl:variable name="currentNumType" select="@numberType"/>
            <xsl:variable name="currentNumTypePrev" select="preceding-sibling::one[1]/@numberType"/>
            <xsl:variable name="currentNumTypeNext" select="following-sibling::one[1]/@numberType"/>
            
            
            <xsl:variable name="currentNumFormat" select="@numberFormat"/>
            <xsl:variable name="currentNumFormatPrev" select="preceding-sibling::one[1]/@numberFormat"/>
            <xsl:variable name="currentNumFormatNext" select="following-sibling::one[1]/@numberFormat"/>
                        ...
                        <!-- List head followed by a list --> 
                        
                        <!--<xsl:if test="preceding-sibling::*[1][self::one] and not($currentNumTypePrev = $currentNumType)">
                        <xsl:text>&#x000A;</xsl:text>
                        <xsl:text disable-output-escaping="yes">&lt;GROUP&gt;</xsl:text>
                  </xsl:if>-->
                        
                        <xsl:if test="preceding-sibling::*[1][self::one] and not($currentNumFormatPrev = $currentNumFormat)">
                              <xsl:text>&#x000A;</xsl:text>
                              <xsl:text disable-output-escaping="yes">&lt;GROUP&gt;</xsl:text>
                        ...
                        <xsl:if test="following-sibling::*[1][self::one] and not($currentNumFormatNext = $currentNumFormat)">
                              <xsl:text>&#x000A;</xsl:text>
                              <xsl:text disable-output-escaping="yes">&lt;/GROUP&gt;</xsl:text>
                        </xsl:if>
                        
                        <!--<xsl:if test="following-sibling::*[1][self::one] and not($currentNumTypeNext = $currentNumType)">
                  <xsl:text>&#x000A;</xsl:text>
                  <xsl:text disable-output-escaping="yes">&lt;/GROUP&gt;</xsl:text>
            </xsl:if>-->
                        <!-- List head followed by a list -->

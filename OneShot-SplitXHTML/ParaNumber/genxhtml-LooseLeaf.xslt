...
<!-- 15-Nov-17: to give highlight for not matching styles --><!-- For LOOSE LEAF concept -->
                                   ...
                                   <xsl:choose>
                                    ...
                                    <RuleAboveColor type="object">Color/S112_2_0_276</RuleAboveColor>
                                       ...
                                       <xsl:otherwise>
                                           <!-- Bookmark start new 21.8.2015 concept -->
                                           <xsl:for-each select="descendant::HyperlinkTextDestination | descendant::HyperlinkTextSource">
                                               <xsl:variable name="bkname" select="@BookMarkDestination"/>
                                               <xsl:variable name="id">
                                                   <xsl:number level="any"/>
                                               </xsl:variable>
                                               <xsl:variable name="HUD">
                                               ...
                                               <!--<xsl:if test="not(ancestor-or-self::Footnote) or not(ancestor-or-self::Note)">-->
                                               <xsl:if test="not(contains($bkname,'FTXID'))">
                                                   <xsl:if test="not(string-length($HUD) =0)">
                                                       <xsl:element name="w:bookmarkStart">
                                                           <!--<xsl:attribute name="w:id" select="$HUD"/>-->
                                                           <xsl:attribute name="w:id" select="$id"/>
...
<!-- <xsl:apply-templates/> -->
                        <!-- 01-Dec-17: GIVE a link for TOC **************************************************************************************************************************************************** -->        
                        <xsl:choose>
                            <xsl:when test="$Na1 = 'BibItem-chap-endmatter'"> 
                                <xsl:element name="a">
                                <xsl:attribute name="id">
                                    <xsl:value-of select="'r'"/>
                                    <!--<xsl:number format="1" level="any" count="w:p[w:pPr/w:pStyle/@w:val = 'BibItem-chap-endmatter']"></xsl:number>-->
                                    <xsl:number format="01" count="ParagraphStyleRange[@AppliedParagraphStyle = 'ParagraphStyle/BibItem-chap-endmatter']" level="any"/>
                                </xsl:attribute>
                                <xsl:attribute name="data-toc" select="'toc'"/>
                                <xsl:apply-templates/>  
                                </xsl:element>
                            </xsl:when>
                            <xsl:when test="$Na1 = 'FootNotes'">
                                <xsl:element name="a">
                                    <xsl:attribute name="id">
                                        <xsl:number format="01" count="ParagraphStyleRange[@AppliedParagraphStyle = 'ParagraphStyle/FootNotes']" level="any"/>
                                    </xsl:attribute>
                                    <xsl:attribute name="href">
                                        <xsl:value-of select="concat($filename,'.xhtml#eref')"/>                  
                                        <xsl:number format="1" count="w:p[w:pPr/w:pStyle/@w:val = 'FootnoteText']" level="any"/>
                                    </xsl:attribute>
                                    <xsl:attribute name="data-toc" select="'toc'"/>
                                    <xsl:apply-templates/>
                                </xsl:element>
                            </xsl:when>
                            <xsl:when test="$Na1 = 'EndnoteText'">
                                <xsl:element name="a">                
                                    <xsl:attribute name="id">
                                        <xsl:value-of select="'e'"/>
                                        <xsl:number format="01" count="ParagraphStyleRange[@AppliedParagraphStyle = 'ParagraphStyle/EndnoteText']" level="any"/>
                                    </xsl:attribute>
                                    <xsl:attribute name="href">
                                        <xsl:value-of select="concat($filename,'.xhtml#eref')"/>                  
                            ...
                            <xsl:when test="$Na1 = 'UnitTitle' or $Na1 = 'PartTitle' or $Na1 = 'SectionTitle' or $Na1 = 'PartNumber' 
                                or $Na1 = 'UnitNmber' or $Na1 = 'SectionNumber' or  $Na1 = 'SectionNumber0' 
                                or $Na1 = 'unittitle' or $Na1 = 'parttitle' or $Na1 = 'sectiontitle' or $Na1 = 'partnumber' 
                                or $Na1 = 'unitumber' or $Na1 = 'sectionnumber' or  $Na1 = 'sectionnumber0'">
                                <xsl:element name="a">                
                                    <xsl:attribute name="id">
                                        <xsl:value-of select="'ch'"/>
                                        <xsl:number format="01" count="ParagraphStyleRange[matches(@AppliedParagraphStyle, 'ParagraphStyle/([A-z\-_]*)?tle$')]" level="any"/>
                                    </xsl:attribute>
                                    <xsl:attribute name="href">
                            ...
                            <xsl:when test="$Na1 = 'ChapterTitle'">
                                <xsl:element name="a">                
                                    <xsl:attribute name="id">
                                        <xsl:value-of select="'ch'"/>
                                        <!--<xsl:number format="01" count="w:p[w:pPr/w:pStyle/@w:val = 'ChapterTitle']" level="any"/>-->
                                        <xsl:number format="01" count="ParagraphStyleRange[@AppliedParagraphStyle = 'ParagraphStyle/ChapterTitle']" level="any"/>
                                    </xsl:attribute>
                                    <xsl:attribute name="href">
                                        <xsl:value-of select="concat('contents.xhtml#',$filename)"/>
                                    </xsl:attribute>
                      ...
                      <xsl:number format="01" count="w:p[w:pPr/w:pStyle/@w:val = 'CT']" level="any"/>-->
                            ...
                            <xsl:when test="$Na1 = 'ChapterAuthor'">
                                <xsl:element name="a">                
                                    <xsl:attribute name="id">
                                        <xsl:value-of select="'ch'"/>
                                        <xsl:number format="01" count="ParagraphStyleRange[@AppliedParagraphStyle = 'ParagraphStyle/ChapterTitle']" level="any"/>
                            ...
                            <xsl:when test="matches($Na1, '^[Hh]([A-z\-_]*)?[0-9]+([A-z\-_]*)$')">
                                <xsl:text>&#x000A;</xsl:text>
                                <xsl:element name="a">                
                                    <xsl:attribute name="id">
                                        <!--10-sep-15: I've deleted the filename here, to shorten in content.xsl <xsl:value-of select="concat($filename,'-sec1-')"/> -->
                                        <xsl:value-of select="'sec'"/>
                                        <xsl:number format="1" count="ParagraphStyleRange[matches(@AppliedParagraphStyle, 'ParagraphStyle/[Hh]([A-z\-_]*)?[0-9]+([A-z\-_]*)$')]" level="any"/>                        
                                        <xsl:value-of select="'_'"/>  
                                        <!--<xsl:number format="1" count="w:p[matches(w:pPr/w:pStyle/@w:val, '^[Hh]([A-z\-_]*)?[0-9]+([A-z\-_]*)$')]" level="any"/>-->
                                        <xsl:number format="01" count="ParagraphStyleRange[matches(@AppliedParagraphStyle, 'ParagraphStyle/[Hh]([A-z\-_]*)?[0-9]+([A-z\-_]*)$')]" level="any"/>
                                    </xsl:attribute>
                                    <xsl:attribute name="href">
                            ...
                            <xsl:when test="matches($Na1, '.*Heading.*')">
                                <xsl:element name="a">                
                                    <xsl:attribute name="id">
                                        <!--10-sep-15: I've deleted the filename here, to shorten in content.xsl <xsl:value-of select="concat($filename,'-sec1-')"/> -->
                            ...
                            <xsl:when test="matches($Na1, '.*Times1')">
                                <xsl:element name="a">                
                                    <xsl:attribute name="id">
                                        <xsl:value-of select="'sec1_'"/>
                                        <xsl:number format="1" level="any"/>
                            ...
                            <xsl:when test="matches($Na1, '.*Times2')">
                                <xsl:element name="a">                
                                    <xsl:attribute name="id">
                            ...
                            <xsl:when test="matches($Na1, '.*Times3')">
                                <xsl:element name="a">                
                                    <xsl:attribute name="id">
                            ...
                            <xsl:when test="matches($Na1, '.*Times4')">
                                <xsl:element name="a">                
                                    <xsl:attribute name="id">
                            ...
                            <xsl:when test="matches($Na1, '.*Times5')">
                                <xsl:element name="a">                
                                    <xsl:attribute name="id">
                            ...
                            <xsl:when test="matches($Na1, '.*Times6')">
                                <xsl:element name="a">                
                                    <xsl:attribute name="id">
                            ...
                            <xsl:when test="matches($Na1, '.*Times7')">
                                <xsl:element name="a">                
                                    <xsl:attribute name="id">
                            ...
                            <xsl:when test="matches($Na1, '.*Times8')">
                                <xsl:element name="a">                
                                    <xsl:attribute name="id">
                            ...
                            <xsl:when test="matches($Na1, '.*Times9')">
                                <xsl:element name="a">                
                                    <xsl:attribute name="id">
                            ...
                            <xsl:when test="$Na1 = 'TOCHdg2'"> 
                                
                            </xsl:when>
                            <xsl:when test="$Na1 = 'TOCHdg3'"> 
                                
                            </xsl:when>
                            <xsl:when test="$Na1 = 'TOCHdg4'"> 
                                
                            </xsl:when>
                            <xsl:when test="$Na1 = 'preview-review-header'"> 
                                
                            </xsl:when>
                            <xsl:when test="$Na1 = 'TOC Hdg2'"> 
                                
                            </xsl:when>
                            <xsl:when test="$Na1 = 'TOC Hdg3'"> 
                                
                            </xsl:when>
                            <xsl:when test="$Na1 = 'TOC Hdg4'"> 
...
<!-- 15-Nov-17: to give highlight for not matching styles -->
        <!-- <span style="background-color: #E8E8E8"> -->
        <xsl:if test="not(@AppliedConditions = 'Condition/Highlight')">
            <xsl:text disable-output-escaping="yes">&lt;span style="background-color: #E8E8E8" contenteditable="false"&gt;</xsl:text>            
        </xsl:if>
<!-- 15-Nov-17: to give highlight for not matching styles --> 
        ...
        <xsl:choose>
            ...
            <xsl:otherwise>
                <xsl:element name="span">
                    ...
                    <!--<xsl:attribute name="data-name">                       
                        <!-\-<xsl:value-of select="$Charstyle22"/>-\->
                        <!-\-<xsl:value-of select="$Charstyle"/> by hari, needs only nested style name 21-nov-17-\->
                        <xsl:value-of select="$NestedAppliedCharacterStyle"/>
                    </xsl:attribute>-->
                    <xsl:choose>
                        <xsl:when test="@NestedAppliedCharacterStyle">
                            ...
                            <xsl:when test="contains($Charstyle0,'smallcaps') or contains($Charstyle0,'allcaps') or @Underline = 'true' or StrikeThru='true' or  contains($Charstyle0,'heavy') or  contains($Charstyle0,'bold') or contains($Charstyle0,'italic') or contains($Charstyle0,'oblique')">
                                ...
                                <xsl:if test="contains($Charstyle0,'subscript')">
                                    ...
                                    <xsl:text disable-output-escaping="yes">&gt;</xsl:text>
                                            ...
                                            <xsl:choose>
                                                <xsl:when test="contains($Charstyle0,'allcaps')">
            ...
            <xsl:element name="cols">
                <xsl:for-each select="self::Table/Column">
                    ...
                    <xsl:element name="colspec">
                        <xsl:attribute name="cols" select="round($CW * 20)"/>
                    </xsl:element>
                </xsl:for-each>
                <xsl:text>&#x000A;</xsl:text>
            </xsl:element>

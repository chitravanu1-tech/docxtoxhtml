...
<!-- 06-NOV-17: Added for Looseleaf (AppliedConditions="Condition/Highlight")-->
                         <!--<xsl:if test="not(descendant::CharacterStyleRange[@AppliedConditions = 'Condition/Highlight'])">
...
<!-- 06-NOV-17: Added for Looseleaf -->
    ...
    <xsl:template match="CharacterStyleRange">
        ...
        <!-- 15-Nov-17: to give highlight for not matching styles -->956
                    ...
                    <xsl:attribute name="data-name">
                        <!--<xsl:choose>
                            <xsl:when test="@NestedAppliedCharacterStyle">
                                ...
                                <xsl:text> </xsl:text>
                                <xsl:value-of select="$NestedAppliedCharacterStyle22"/>
                            </xsl:when>
                            <xsl:otherwise>
                                <xsl:value-of select="$Charstyle22"/>
                            </xsl:otherwise>

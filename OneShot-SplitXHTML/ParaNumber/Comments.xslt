...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:mf="http://example.com/mf" exclude-result-prefixes="xs mf idPkg" 
    ...
    <xsl:template match="Note">
        <xsl:element name="w:comment">
            ...
            <xsl:variable name="keypairVal" select="child::Properties/Label/KeyValuePair/@Value"/>
...
<!--                            <xsl:element name="wp:wrapTopAndBottom"/>-->
    ...
    <!-- Added sorting issue by HyperlinkTextSourceon 10-1-2022 -->
    <xsl:template match="HyperlinkTextSource[contains(lower-case(@HyperlinkUDestination),'_story_')]|HyperlinkTextDestination[contains(@BookMarkDestination,'_UUID_') or contains(@BookMarkDestination,'story') or contains(@Name,'_UUID_') or contains(lower-case(@Name),'_story_')]">

...
<!-- Added [not(contains(lower-case(@BookMarkDestination),'anchor') or contains(lower-case(@Name),'anchor'))] to avoid anchor and sorting by anchor on 19-12-2021 -->
...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <!-- Added [not(contains(lower-case(@BookMarkDestination),'anchor') or contains(lower-case(@Name),'anchor'))] to avoid anchor and sorting by anchor on 19-12-2021 -->
    <xsl:template match="HyperlinkTextDestination[contains(@Name,'_UUID_') or contains(lower-case(@Name),'_story_') or contains(substring-after(@Self,'HyperlinkTextDestination/'),'_UUID_') or contains(substring-after(@Self,'HyperlinkTextDestination/'),'_Story_')][not(contains(lower-case(@BookMarkDestination),'anchor') or contains(lower-case(@Name),'anchor'))]" priority="2">
    ...
    <!-- Added to avoid anchor hyperlink on 19-12-2021 -->
    <!--<xsl:template match="//HyperlinkTextDestination[contains(lower-case(@BookMarkDestination),'anchor') or contains(lower-case(@Name),'anchor')]"/>-->
    <!-- End -->
</xsl:stylesheet>

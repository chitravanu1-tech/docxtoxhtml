...
<!-- 07-Feb-18: The following when is only for "LUSTER" client -->
      ...
      <!--Added on 1-09-2021-->
      <!--Added for marriapan editor on 10-20-2021-->
      <!-- Added to avoid the issue when merge the url on 2-4-2022 -->
      <!-- Added to remove the endnote citation number with formating on 19-4-2022 -->
      <!--To avoid the span[@class='EndnoteReference'] inside span[@class='EndnoteReference'] on 6-09-2022 -->  
      ...
      <xsl:template match="ol29-Nov-17">
            <xsl:variable name="className" select="@class"/>
            
            
            <xsl:choose>
                  <xsl:when test="preceding-sibling::*[1][self::ol]">
                        <xsl:apply-templates/>
                  </xsl:when>
                  <xsl:otherwise>
            ...
            <xsl:choose>
                  <xsl:when test="following-sibling::*[1][self::ol]">                        
     ...
     <xsl:template match="GROUP">
           <xsl:choose>
                 <xsl:when test="not(preceding-sibling::*[1][self::GROUP])">
                       <xsl:choose>
                             <xsl:when test="child::two">                                   
                                   <xsl:text disable-output-escaping="yes">&lt;GROUP listtype="</xsl:text>
                                   <xsl:value-of select="following::one[1]/@listtype"/>
                                   <xsl:text disable-output-escaping="yes">" numberFormat="</xsl:text>
                                   <xsl:value-of select="following::one[1]/@numberFormat"/>
                                   <xsl:text disable-output-escaping="yes">" numberType="</xsl:text>
                                   <xsl:value-of select="following::one[1]/@numberType"/>
                                   <xsl:text disable-output-escaping="yes">" start="</xsl:text>
                                   <xsl:value-of select="following::one[1]/@start"/>
                                   <xsl:text disable-output-escaping="yes">"&gt;</xsl:text>
                                   <xsl:text disable-output-escaping="yes">&lt;one listtype="</xsl:text>                                   
                                   <!--<xsl:value-of select="following::one[1]/@numberFormat"/>-->
                             ...
                             <xsl:when test="child::three">
                                   ...
                                   <xsl:text disable-output-escaping="yes">&lt;/GROUP&gt;</xsl:text>                                   
                                   <xsl:text disable-output-escaping="yes">&lt;GROUP listtype="</xsl:text>
                                   <xsl:value-of select="following::two[1]/@listtype"/>
                                   <xsl:text disable-output-escaping="yes">" numberFormat="</xsl:text>
                                   <xsl:value-of select="following::two[1]/@numberFormat"/>
                                   <xsl:text disable-output-escaping="yes">" numberType="</xsl:text>
                                   <xsl:value-of select="following::two[1]/@numberType"/>
                                   <xsl:text disable-output-escaping="yes">" start="</xsl:text>
                                   <xsl:value-of select="following::two[1]/@start"/>
                                   <xsl:text disable-output-escaping="yes">"&gt;</xsl:text>
                                   <xsl:text disable-output-escaping="yes">&lt;two listtype="dummy"&gt;</xsl:text>
                             ...
                             <xsl:when test="child::four">
                                   ...
                                   <xsl:text disable-output-escaping="yes">&lt;/GROUP&gt;</xsl:text>
                                   <xsl:text disable-output-escaping="yes">&lt;GROUP listtype="</xsl:text>
                                   <xsl:value-of select="following::three[1]/@listtype"/>
                                   <xsl:text disable-output-escaping="yes">" numberFormat="</xsl:text>
                                   <xsl:value-of select="following::three[1]/@numberFormat"/>
                                   <xsl:text disable-output-escaping="yes">" numberType="</xsl:text>
                                   <xsl:value-of select="following::three[1]/@numberType"/>
                                   <xsl:text disable-output-escaping="yes">" start="</xsl:text>
                                   <xsl:value-of select="following::three[1]/@start"/>
                                   <xsl:text disable-output-escaping="yes">"&gt;</xsl:text>
                                   <xsl:text disable-output-escaping="yes">&lt;three listtype="dummy"&gt;</xsl:text>
                             ...
                             <xsl:when test="child::five">
                                   ...
                                   <xsl:text disable-output-escaping="yes">&lt;/GROUP&gt;</xsl:text>
                                   <xsl:text disable-output-escaping="yes">&lt;GROUP listtype="</xsl:text>
                                   <xsl:value-of select="following::four[1]/@listtype"/>
                                   <xsl:text disable-output-escaping="yes">" numberFormat="</xsl:text>
                                   <xsl:value-of select="following::four[1]/@numberFormat"/>
                                   <xsl:text disable-output-escaping="yes">" numberType="</xsl:text>
                                   <xsl:value-of select="following::four[1]/@numberType"/>
                                   <xsl:text disable-output-escaping="yes">" start="</xsl:text>
                                   <xsl:value-of select="following::four[1]/@start"/>
                                   <xsl:text disable-output-escaping="yes">"&gt;</xsl:text>
                                   <xsl:text disable-output-escaping="yes">&lt;four listtype="dummy"&gt;</xsl:text>
                             ...
                             <xsl:when test="child::six">
                                   ...
                                   <xsl:text disable-output-escaping="yes">&lt;/GROUP&gt;</xsl:text>
                                   <xsl:text disable-output-escaping="yes">&lt;GROUP listtype="</xsl:text>
                                   <xsl:value-of select="following::five[1]/@listtype"/>
                                   <xsl:text disable-output-escaping="yes">" numberFormat="</xsl:text>
                                   <xsl:value-of select="following::five[1]/@numberFormat"/>
                                   <xsl:text disable-output-escaping="yes">" numberType="</xsl:text>
                                   <xsl:value-of select="following::five[1]/@numberType"/>
                                   <xsl:text disable-output-escaping="yes">" start="</xsl:text>
                                   <xsl:value-of select="following::five[1]/@start"/>
                                   <xsl:text disable-output-escaping="yes">"&gt;</xsl:text>
                                   <xsl:text disable-output-escaping="yes">&lt;five listtype="dummy"&gt;</xsl:text>
                             ...
                             <xsl:when test="child::seven">
                                   ...
                                   <xsl:text disable-output-escaping="yes">&lt;/GROUP&gt;</xsl:text>                                   
                                   <xsl:text disable-output-escaping="yes">&lt;GROUP listtype="</xsl:text>
                                   <xsl:value-of select="following::six[1]/@listtype"/>
                                   <xsl:text disable-output-escaping="yes">" numberFormat="</xsl:text>
                                   <xsl:value-of select="following::six[1]/@numberFormat"/>
                                   <xsl:text disable-output-escaping="yes">" numberType="</xsl:text>
                                   <xsl:value-of select="following::six[1]/@numberType"/>
                                   <xsl:text disable-output-escaping="yes">" start="</xsl:text>
                                   <xsl:value-of select="following::six[1]/@start"/>
                                   <xsl:text disable-output-escaping="yes">"&gt;</xsl:text>
                                   <xsl:text disable-output-escaping="yes">&lt;six listtype="dummy"&gt;</xsl:text>
                             ...
                             <xsl:when test="child::eight">
                                   ...
                                   <xsl:text disable-output-escaping="yes">&lt;/GROUP&gt;</xsl:text>
                                   <xsl:text disable-output-escaping="yes">&lt;GROUP listtype="</xsl:text>
                                   <xsl:value-of select="following::seven[1]/@listtype"/>
                                   <xsl:text disable-output-escaping="yes">" numberFormat="</xsl:text>
                                   <xsl:value-of select="following::seven[1]/@numberFormat"/>
                                   <xsl:text disable-output-escaping="yes">" numberType="</xsl:text>
                                   <xsl:value-of select="following::seven[1]/@numberType"/>
                                   <xsl:text disable-output-escaping="yes">" start="</xsl:text>
                                   <xsl:value-of select="following::seven[1]/@start"/>
                                   <xsl:text disable-output-escaping="yes">"&gt;</xsl:text>
                                   <xsl:text disable-output-escaping="yes">&lt;seven listtype="dummy"&gt;</xsl:text>
                             ...
                             <xsl:when test="child::nine">
                                   ...
                                   <xsl:text disable-output-escaping="yes">&lt;/GROUP&gt;</xsl:text>
                                   <xsl:text disable-output-escaping="yes">&lt;GROUP listtype="</xsl:text>
                                   <xsl:value-of select="following::eight[1]/@listtype"/>
                                   <xsl:text disable-output-escaping="yes">" numberFormat="</xsl:text>
                                   <xsl:value-of select="following::eight[1]/@numberFormat"/>
                                   <xsl:text disable-output-escaping="yes">" numberType="</xsl:text>
                                   <xsl:value-of select="following::eight[1]/@numberType"/>
                                   <xsl:text disable-output-escaping="yes">" start="</xsl:text>
                                   <xsl:value-of select="following::eight[1]/@start"/>
                                   <xsl:text disable-output-escaping="yes">"&gt;</xsl:text>
                                   <xsl:text disable-output-escaping="yes">&lt;eight lisytype="dummy"&gt;</xsl:text>
                             ...
                             <xsl:when test="child::ten">
                                   ...
                                   <xsl:text disable-output-escaping="yes">&lt;/GROUP&gt;</xsl:text>
                                   <xsl:text disable-output-escaping="yes">&lt;GROUP listtype="</xsl:text>
                                   <xsl:value-of select="following::nine[1]/@listtype"/>
                                   <xsl:text disable-output-escaping="yes">" numberFormat="</xsl:text>
                                   <xsl:value-of select="following::nine[1]/@numberFormat"/>
                                   <xsl:text disable-output-escaping="yes">" numberType="</xsl:text>
                                   <xsl:value-of select="following::nine[1]/@numberType"/>
                                   <xsl:text disable-output-escaping="yes">" start="</xsl:text>
                                   <xsl:value-of select="following::nine[1]/@start"/>
                                   <xsl:text disable-output-escaping="yes">"&gt;</xsl:text>
                                   <xsl:text disable-output-escaping="yes">&lt;nine lisytype="dummy"&gt;</xsl:text>
                 ...
                 <xsl:when test="preceding-sibling::*[1][self::GROUP]">
                       <xsl:choose>
                             <xsl:when test="child::two">  
                                   <xsl:choose>
                                         <xsl:when test="preceding-sibling::*[1][self::GROUP/one]"> 
                                               
                                               <xsl:text disable-output-escaping="yes">&lt;GROUP listtype="</xsl:text>
                                               <xsl:value-of select="child::*[1]/@listtype"/>
                                               <xsl:text disable-output-escaping="yes">" numberFormat="</xsl:text>
                                               <xsl:value-of select="child::*[1]/@numberFormat"/>
                                               <xsl:text disable-output-escaping="yes">" numberType="</xsl:text>
                                               <xsl:value-of select="child::*[1]/@numberType"/>
                                               <xsl:text disable-output-escaping="yes">" start="</xsl:text>
                                               <xsl:value-of select="child::*[1]/@start"/>
                                               <xsl:text disable-output-escaping="yes">"&gt;</xsl:text>
                                               <xsl:apply-templates/>
                                               <xsl:text disable-output-escaping="yes">&lt;/GROUP&gt;</xsl:text>
                                               <!--<xsl:copy>
                                   ...
                                   <!--<xsl:text disable-output-escaping="yes">&lt;GROUP&gt;</xsl:text>
                                   <xsl:text disable-output-escaping="yes">&lt;one lisytype="dummy"&gt;</xsl:text>
                                   <xsl:text disable-output-escaping="yes">&lt;/one&gt;</xsl:text>
                                   <xsl:text disable-output-escaping="yes">&lt;/GROUP&gt;</xsl:text>
                             ...
                             <xsl:when test="child::three">
                                   <xsl:choose>
                                         <xsl:when test="preceding-sibling::*[1][self::GROUP/one]">
                                               ...
                                               <xsl:value-of select="following::two[1]/@start"/>
                                               <xsl:text disable-output-escaping="yes">"&gt;</xsl:text>
                                               <xsl:text disable-output-escaping="yes">&lt;two listtype="</xsl:text>                                   
                                               <xsl:value-of select="following::two[1]/@numberFormat"/>
                                               <xsl:text disable-output-escaping="yes">"&gt;</xsl:text>
                                               <xsl:text disable-output-escaping="yes">&lt;/two&gt;</xsl:text>                                   
                                               <xsl:text disable-output-escaping="yes">&lt;/GROUP&gt;</xsl:text>
                                         ...
                                         <!-- 02-may-17 -->
                                         <xsl:when test="preceding-sibling::*[1][self::GROUP/twXo]">
                                               <xsl:text disable-output-escaping="yes">&lt;GROUP listtype="</xsl:text>
                                               <xsl:value-of select="following::two[1]/@listtype"/>
                                               <xsl:text disable-output-escaping="yes">" numberFormat="</xsl:text>
                                               <xsl:value-of select="following::two[1]/@numberFormat"/>
                                         ...
                                         <xsl:otherwise>
                                               ...
                                               <xsl:text disable-output-escaping="yes">&lt;GROUP listtype="</xsl:text>
                                               <xsl:value-of select="child::three[1]/@listtype"/>
                                               <xsl:text disable-output-escaping="yes">" numberFormat="</xsl:text>
                                               <xsl:value-of select="child::three[1]/@numberFormat"/>
                                               <xsl:text disable-output-escaping="yes">" numberType="</xsl:text>
                                               <xsl:value-of select="child::three[1]/@numberType"/>
                                               <xsl:text disable-output-escaping="yes">" start="</xsl:text>
                                               <xsl:value-of select="child::three[1]/@start"/>
                                               <xsl:text disable-output-escaping="yes">"&gt;</xsl:text>
                                               <xsl:apply-templates select="@*|node()"/>                             
                                               <xsl:text disable-output-escaping="yes">&lt;/GROUP&gt;</xsl:text>
                                   ...
                                   <xsl:text disable-output-escaping="yes">&lt;/GROUP&gt;</xsl:text>                                   
                                   <xsl:text disable-output-escaping="yes">&lt;GROUP&gt;</xsl:text>
                                   <xsl:text disable-output-escaping="yes">&lt;two lisytype="dummy"&gt;</xsl:text>
                                   <xsl:text disable-output-escaping="yes">&lt;/two&gt;</xsl:text>                                   
                                   <xsl:text disable-output-escaping="yes">&lt;/GROUP&gt;</xsl:text>
                             ...
                             <xsl:when test="child::four">
                                   <xsl:choose>
                                         <xsl:when test="preceding-sibling::*[1][self::GROUP/one]">                                                                             
                                               ...
                                               <xsl:value-of select="following::three[1]/@start"/>
                                               <xsl:text disable-output-escaping="yes">"&gt;</xsl:text>
                                               <xsl:text disable-output-escaping="yes">&lt;three lisytype="dummy"&gt;</xsl:text>
                                               <xsl:text disable-output-escaping="yes">&lt;/three&gt;</xsl:text>                                   
                                               <xsl:text disable-output-escaping="yes">&lt;/GROUP&gt;</xsl:text>                                               
                                         ...
                                         <xsl:when test="preceding-sibling::*[1][self::GROUP/two]">
                                               <xsl:text disable-output-escaping="yes">&lt;GROUP listtype="</xsl:text>
                                               <xsl:value-of select="following::three[1]/@listtype"/>
                                               <xsl:text disable-output-escaping="yes">" numberFormat="</xsl:text>
                                               <xsl:value-of select="following::three[1]/@numberFormat"/>
                                               ...
                                               <xsl:value-of select="following::three[1]/@start"/>
                                               <xsl:text disable-output-escaping="yes">"&gt;</xsl:text>
                                               <xsl:text disable-output-escaping="yes">&lt;three listtype="</xsl:text>                                   
                                               <!--<xsl:value-of select="following::three[1]/@numberFormat"/>-->
                                               <xsl:text>dummy</xsl:text>
                                               <xsl:text disable-output-escaping="yes">"&gt;</xsl:text>
                                               <xsl:text disable-output-escaping="yes">&lt;/three&gt;</xsl:text>                                   
                                         ...
                                         <xsl:otherwise>
                                               ...
                                               <xsl:text disable-output-escaping="yes">&lt;GROUP listtype="</xsl:text>
                                               <xsl:value-of select="child::four[1]/@listtype"/>
                                               <xsl:text disable-output-escaping="yes">" numberFormat="</xsl:text>
                                               <xsl:value-of select="child::four[1]/@numberFormat"/>
                                               <xsl:text disable-output-escaping="yes">" numberType="</xsl:text>
                                               <xsl:value-of select="child::four[1]/@numberType"/>
                                               <xsl:text disable-output-escaping="yes">" start="</xsl:text>
                                               <xsl:value-of select="child::four[1]/@start"/>
                                               <xsl:text disable-output-escaping="yes">"&gt;</xsl:text>
                                               <xsl:apply-templates select="@*|node()"/>                             
                                               <xsl:text disable-output-escaping="yes">&lt;/GROUP&gt;</xsl:text>
                                   ...
                                   <!--<xsl:if test="preceding-sibling::*[1][self::GROUP/one]">
                                         <xsl:text disable-output-escaping="yes">&lt;GROUP&gt;</xsl:text>
                                         <xsl:text disable-output-escaping="yes">&lt;one lisytype="dummy"&gt;</xsl:text>
                                         <xsl:text disable-output-escaping="yes">&lt;/one&gt;</xsl:text>
                                         <xsl:text disable-output-escaping="yes">&lt;/GROUP&gt;</xsl:text>                                   
                             ...
                             <xsl:when test="child::five">
                                   <xsl:choose>
                                         <xsl:when test="preceding-sibling::*[1][self::GROUP/one]">                                                                             
                                               ...
                                               <xsl:value-of select="following::four[1]/@start"/>
                                               <xsl:text disable-output-escaping="yes">"&gt;</xsl:text>
                                               <xsl:text disable-output-escaping="yes">&lt;four lisytype="dummy"&gt;</xsl:text>
                                               <xsl:text disable-output-escaping="yes">&lt;/four&gt;</xsl:text>                                   
                                               <xsl:text disable-output-escaping="yes">&lt;/GROUP&gt;</xsl:text>  
                                         ...
                                         <xsl:when test="preceding-sibling::*[1][self::GROUP/three]">                                               
                                               <xsl:text disable-output-escaping="yes">&lt;GROUP listtype="</xsl:text>
                                               <xsl:value-of select="following::four[1]/@listtype"/>
                                               <xsl:text disable-output-escaping="yes">" numberFormat="</xsl:text>
                                               <xsl:value-of select="following::four[1]/@numberFormat"/>
                                               ...
                                               <xsl:value-of select="following::four[1]/@start"/>
                                               <xsl:text disable-output-escaping="yes">"&gt;</xsl:text>
                                               <xsl:text disable-output-escaping="yes">&lt;four listtype="</xsl:text>                                   
                                               <!--<xsl:value-of select="following::four[1]/@numberFormat"/>-->                                               
                                               <xsl:text>dummy</xsl:text>
                                               <xsl:text disable-output-escaping="yes">"&gt;</xsl:text>
                                               <xsl:text disable-output-escaping="yes">&lt;/four&gt;</xsl:text>                                   
                                         ...
                                         <xsl:otherwise>
                                               ...
                                               <xsl:text disable-output-escaping="yes">&lt;GROUP listtype="</xsl:text>
                                               <xsl:value-of select="child::five[1]/@listtype"/>
                                               <xsl:text disable-output-escaping="yes">" numberFormat="</xsl:text>
                                               <xsl:value-of select="child::five[1]/@numberFormat"/>
                                               <xsl:text disable-output-escaping="yes">" numberType="</xsl:text>
                                               <xsl:value-of select="child::five[1]/@numberType"/>
                                               <xsl:text disable-output-escaping="yes">" start="</xsl:text>
                                               <xsl:value-of select="child::five[1]/@start"/>
                                               <xsl:text disable-output-escaping="yes">"&gt;</xsl:text>
                                               <xsl:apply-templates select="@*|node()"/>                             
                                               <xsl:text disable-output-escaping="yes">&lt;/GROUP&gt;</xsl:text>
                             ...
                             <xsl:when test="child::six">
                                   <xsl:choose>
                                         <xsl:when test="preceding-sibling::*[1][self::GROUP/one]">                                                                             
                                               ...
                                               <xsl:value-of select="following::five[1]/@start"/>
                                               <xsl:text disable-output-escaping="yes">"&gt;</xsl:text>
                                               <xsl:text disable-output-escaping="yes">&lt;five lisytype="dummy"&gt;</xsl:text>
                                               <xsl:text disable-output-escaping="yes">&lt;/five&gt;</xsl:text>                                   
                                               <xsl:text disable-output-escaping="yes">&lt;/GROUP&gt;</xsl:text> 
                                         ...
                                         <xsl:when test="preceding-sibling::*[1][self::GROUP/four]">
                                               <xsl:text disable-output-escaping="yes">&lt;GROUP listtype="</xsl:text>
                                               <xsl:value-of select="following::five[1]/@listtype"/>
                                               <xsl:text disable-output-escaping="yes">" numberFormat="</xsl:text>
                                               <xsl:value-of select="following::five[1]/@numberFormat"/>
                                               ...
                                               <xsl:value-of select="following::five[1]/@start"/>
                                               <xsl:text disable-output-escaping="yes">"&gt;</xsl:text>
                                               <xsl:text disable-output-escaping="yes">&lt;five listtype="</xsl:text>                                   
                                               <!--<xsl:value-of select="following::five[1]/@numberFormat"/>-->
                                               <xsl:text>dummy</xsl:text>
                                               <xsl:text disable-output-escaping="yes">"&gt;</xsl:text>
                                               <xsl:text disable-output-escaping="yes">&lt;/five&gt;</xsl:text>                                                                      
                                         ...
                                         <xsl:otherwise>
                                               ...
                                               <xsl:text disable-output-escaping="yes">&lt;GROUP listtype="</xsl:text>
                                               <xsl:value-of select="child::six[1]/@listtype"/>
                                               <xsl:text disable-output-escaping="yes">" numberFormat="</xsl:text>
                                               <xsl:value-of select="child::six[1]/@numberFormat"/>
                                               <xsl:text disable-output-escaping="yes">" numberType="</xsl:text>
                                               <xsl:value-of select="child::six[1]/@numberType"/>
                                               <xsl:text disable-output-escaping="yes">" start="</xsl:text>
                                               <xsl:value-of select="child::six[1]/@start"/>
                                               <xsl:text disable-output-escaping="yes">"&gt;</xsl:text>
                                               <xsl:apply-templates select="@*|node()"/>                             
                                               <xsl:text disable-output-escaping="yes">&lt;/GROUP&gt;</xsl:text>
                             ...
                             <xsl:when test="child::seven">
                                   <xsl:choose>
                                         <xsl:when test="preceding-sibling::*[1][self::GROUP/one]">                                                                             
                                               ...
                                               <xsl:value-of select="following::six[1]/@start"/>
                                               <xsl:text disable-output-escaping="yes">"&gt;</xsl:text>
                                               <xsl:text disable-output-escaping="yes">&lt;six lisytype="dummy"&gt;</xsl:text>
                                               <xsl:text disable-output-escaping="yes">&lt;/six&gt;</xsl:text>                                   
                                               <xsl:text disable-output-escaping="yes">&lt;/GROUP&gt;</xsl:text>
                                         ...
                                         <xsl:when test="preceding-sibling::*[1][self::GROUP/five]">
                                               <xsl:text disable-output-escaping="yes">&lt;GROUP listtype="</xsl:text>
                                               <xsl:value-of select="following::six[1]/@listtype"/>
                                               <xsl:text disable-output-escaping="yes">" numberFormat="</xsl:text>
                                               <xsl:value-of select="following::six[1]/@numberFormat"/>
                                               ...
                                               <xsl:value-of select="following::six[1]/@start"/>
                                               <xsl:text disable-output-escaping="yes">"&gt;</xsl:text>
                                               <xsl:text disable-output-escaping="yes">&lt;six listtype="</xsl:text>                                   
                                               <!--<xsl:value-of select="following::six[1]/@numberFormat"/>-->
                                               <xsl:text>dummy</xsl:text>
                                               <xsl:text disable-output-escaping="yes">"&gt;</xsl:text>
                                               <xsl:text disable-output-escaping="yes">&lt;/six&gt;</xsl:text>                                   
                                         ...
                                         <xsl:otherwise>
                                               ...
                                               <xsl:text disable-output-escaping="yes">&lt;GROUP listtype="</xsl:text>
                                               <xsl:value-of select="child::seven[1]/@listtype"/>
                                               <xsl:text disable-output-escaping="yes">" numberFormat="</xsl:text>
                                               <xsl:value-of select="child::seven[1]/@numberFormat"/>
                                               <xsl:text disable-output-escaping="yes">" numberType="</xsl:text>
                                               <xsl:value-of select="child::seven[1]/@numberType"/>
                                               <xsl:text disable-output-escaping="yes">" start="</xsl:text>
                                               <xsl:value-of select="child::seven[1]/@start"/>
                                               <xsl:text disable-output-escaping="yes">"&gt;</xsl:text>
                                               <xsl:apply-templates select="@*|node()"/>                             
                                               <xsl:text disable-output-escaping="yes">&lt;/GROUP&gt;</xsl:text>
                             ...
                             <xsl:when test="child::eight">
                                   <xsl:choose>
                                         <xsl:when test="preceding-sibling::*[1][self::GROUP/one]">                                                                             
                                               ...
                                               <xsl:value-of select="following::seven[1]/@start"/>
                                               <xsl:text disable-output-escaping="yes">"&gt;</xsl:text>
                                               <xsl:text disable-output-escaping="yes">&lt;seven lisytype="dummy"&gt;</xsl:text>
                                               <xsl:text disable-output-escaping="yes">&lt;/seven&gt;</xsl:text>                                   
                                               <xsl:text disable-output-escaping="yes">&lt;/GROUP&gt;</xsl:text>
                                         ...
                                         <xsl:when test="preceding-sibling::*[1][self::GROUP/six]">
                                               <xsl:text disable-output-escaping="yes">&lt;GROUP listtype="</xsl:text>
                                               <xsl:value-of select="following::seven[1]/@listtype"/>
                                               <xsl:text disable-output-escaping="yes">" numberFormat="</xsl:text>
                                               <xsl:value-of select="following::seven[1]/@numberFormat"/>
                                               ...
                                               <xsl:value-of select="following::seven[1]/@start"/>
                                               <xsl:text disable-output-escaping="yes">"&gt;</xsl:text>
                                               <xsl:text disable-output-escaping="yes">&lt;seven listtype="</xsl:text>                                   
                                               <!--<xsl:value-of select="following::seven[1]/@numberFormat"/>-->
                                               <xsl:text>dummy</xsl:text>
                                               <xsl:text disable-output-escaping="yes">"&gt;</xsl:text>
                                               <xsl:text disable-output-escaping="yes">&lt;/seven&gt;</xsl:text>                                   
                                         ...
                                         <xsl:otherwise>
                                               ...
                                               <xsl:text disable-output-escaping="yes">&lt;GROUP listtype="</xsl:text>
                                               <xsl:value-of select="child::eight[1]/@listtype"/>
                                               <xsl:text disable-output-escaping="yes">" numberFormat="</xsl:text>
                                               <xsl:value-of select="child::eight[1]/@numberFormat"/>
                                               <xsl:text disable-output-escaping="yes">" numberType="</xsl:text>
                                               <xsl:value-of select="child::eight[1]/@numberType"/>
                                               <xsl:text disable-output-escaping="yes">" start="</xsl:text>
                                               <xsl:value-of select="child::eight[1]/@start"/>
                                               <xsl:text disable-output-escaping="yes">"&gt;</xsl:text>
                                               <xsl:apply-templates select="@*|node()"/>                             
                                               <xsl:text disable-output-escaping="yes">&lt;/GROUP&gt;</xsl:text>
                             ...
                             <xsl:when test="child::nine">
                                   <xsl:choose>
                                         ...
                                         <xsl:when test="preceding-sibling::*[1][self::GROUP/seven]">
                                               <xsl:text disable-output-escaping="yes">&lt;GROUP listtype="</xsl:text>
                                               <xsl:value-of select="following::eight[1]/@listtype"/>
                                               <xsl:text disable-output-escaping="yes">" numberFormat="</xsl:text>
                                               <xsl:value-of select="following::eight[1]/@numberFormat"/>
                                               ...
                                               <xsl:value-of select="following::eight[1]/@start"/>
                                               <xsl:text disable-output-escaping="yes">"&gt;</xsl:text>
                                               <xsl:text disable-output-escaping="yes">&lt;eight listtype="</xsl:text>                                   
                                              <!-- <xsl:value-of select="following::eight[1]/@numberFormat"/>-->
                                               <xsl:text>dummy</xsl:text>
                                               <xsl:text disable-output-escaping="yes">"&gt;</xsl:text>
                                               <xsl:text disable-output-escaping="yes">&lt;/eight&gt;</xsl:text>                                   
                                         ...
                                         <xsl:otherwise>
                                               ...
                                               <xsl:text disable-output-escaping="yes">&lt;GROUP listtype="</xsl:text>
                                               <xsl:value-of select="child::nine[1]/@listtype"/>
                                               <xsl:text disable-output-escaping="yes">" numberFormat="</xsl:text>
                                               <xsl:value-of select="child::nine[1]/@numberFormat"/>
                                               <xsl:text disable-output-escaping="yes">" numberType="</xsl:text>
                                               <xsl:value-of select="child::nine[1]/@numberType"/>
                                               <xsl:text disable-output-escaping="yes">" start="</xsl:text>
                                               <xsl:value-of select="child::nine[1]/@start"/>
                                               <xsl:text disable-output-escaping="yes">"&gt;</xsl:text>
                                               <xsl:apply-templates select="@*|node()"/>                             
                                               <xsl:text disable-output-escaping="yes">&lt;/GROUP&gt;</xsl:text>
                             ...
                             <xsl:when test="child::ten">
                                   <xsl:choose>
                                         ...
                                         <xsl:when test="preceding-sibling::*[1][self::GROUP/eight]">
                                               <xsl:text disable-output-escaping="yes">&lt;GROUP listtype="</xsl:text>
                                               <xsl:value-of select="following::nine[1]/@listtype"/>
                                               <xsl:text disable-output-escaping="yes">" numberFormat="</xsl:text>
                                               <xsl:value-of select="following::nine[1]/@numberFormat"/>
                                               ...
                                               <xsl:value-of select="following::nine[1]/@start"/>
                                               <xsl:text disable-output-escaping="yes">"&gt;</xsl:text>
                                               <xsl:text disable-output-escaping="yes">&lt;nine listtype="</xsl:text>                                   
                                               <!--<xsl:value-of select="following::nine[1]/@numberFormat"/>-->
                                               <xsl:text>dummy</xsl:text>
                                               <xsl:text disable-output-escaping="yes">"&gt;</xsl:text>
                                               <xsl:text disable-output-escaping="yes">&lt;/nine&gt;</xsl:text>                                   
                                         ...
                                         <xsl:otherwise>
                                               ...
                                               <xsl:text disable-output-escaping="yes">&lt;GROUP listtype="</xsl:text>
                                               <xsl:value-of select="child::ten[1]/@listtype"/>
                                               <xsl:text disable-output-escaping="yes">" numberFormat="</xsl:text>
                                               <xsl:value-of select="child::ten[1]/@numberFormat"/>
                                               <xsl:text disable-output-escaping="yes">" numberType="</xsl:text>
                                               <xsl:value-of select="child::ten[1]/@numberType"/>
                                               <xsl:text disable-output-escaping="yes">" start="</xsl:text>
                                               <xsl:value-of select="child::ten[1]/@start"/>
                                               <xsl:text disable-output-escaping="yes">"&gt;</xsl:text>
                                               <xsl:apply-templates select="@*|node()"/>                             
                                               <xsl:text disable-output-escaping="yes">&lt;/GROUP&gt;</xsl:text>
...
<!-- 07-Feb-18: The following when is only for "LUSTER" client -->
      <xsl:template match="tbodyX">
            <xsl:variable name="colcount" select="count(child::tr[1]/td)"/>            
            <xsl:element name="colgroup">
                  <xsl:attribute name="cols" select="$colcount"/>
                  <xsl:for-each select="1 to $colcount">
                        
                       <xsl:element name="col">
                             <xsl:attribute name="width">
                                   <xsl:value-of select="(100 div $colcount)"/>
                                   <xsl:text>%</xsl:text>
                             </xsl:attribute>
                       </xsl:element> 
                  </xsl:for-each>
...
<xsl:output-character character=" " string="&amp;#x2029;"/>
      ...
      <!--For index on 25-01-2021-->
      <xsl:template match="span[@data-mark]">
            <xsl:copy>
                  <xsl:apply-templates select="@*"/>
                  <xsl:attribute name="data-mark">
            <xsl:for-each select="self::span[@data-mark]">
                  
                  
                  <xsl:if test="preceding::span[1][@data-id1='index1']">
                        
                        <xsl:value-of select="preceding::span[1][@data-id1='index1']/@data-id"/>
                        </xsl:if> 
                        
                        <xsl:if test="preceding::span[1][@data-id1='index2']">
                              
                              <xsl:value-of select="preceding::span[1][@data-id1='index2']/@data-id"/>
                        </xsl:if>
                  
                  <xsl:if test="preceding::span[1][@data-id1='index3']">
                        
                        <xsl:value-of select="preceding::span[1][@data-id1='index3']/@data-id"/>
                  </xsl:if>
                  <xsl:if test="preceding::span[1][@data-id1='index4']">
                        
                        <xsl:value-of select="preceding::span[1][@data-id1='index4']/@data-id"/>
                  </xsl:if>
                  
            </xsl:for-each>
                        <xsl:value-of select="@data-mark"/>
                  </xsl:attribute>
                  <xsl:apply-templates select="node()"/>
            </xsl:copy>
      </xsl:template>
      <!--Added on 1-09-2021-->
      <xsl:template match="figcaption[not(parent::figure)]">
            <xsl:element name="figure">
                  <!--Added for marriapan editor on 10-20-2021-->
                  <xsl:if test="self::figcaption[child::img]">
      ...
      <!-- Added to avoid the issue when merge the url on 2-4-2022 -->
      <xsl:template match="a[@data-hyperlink][descendant::span[@data-urlstart ='start']][not(descendant::span[@data-urlstart='End'])]">
            <xsl:apply-templates select="descendant::span[@data-urlstart ='start']"/>
            <xsl:copy>
                  <xsl:apply-templates select="@*|node() except span[@data-urlstart ='start']"/>
            </xsl:copy>
      </xsl:template>
      <xsl:template match="a[@data-hyperlink][not(descendant::span[@data-urlstart ='start'])][descendant::span[@data-urlstart='End']]">
             <xsl:copy>
                   <xsl:apply-templates select="@*|node() except span[@data-urlstart ='End']"/>
            </xsl:copy>
            <xsl:apply-templates select="descendant::span[@data-urlstart ='End']"/>
      </xsl:template>
      <xsl:template match="span[@class='EndnoteReference'][not(//child::a[@class='endnotecitation' or @class='crossref'])]/@class"/>
      <xsl:template match="span[@data-name='endnote reference'][not(//child::a[@class='endnotecitation' or @class='crossref'])]/@data-name"/>
      <!-- Added to remove the endnote citation number with formating on 19-4-2022 -->
      <xsl:template match="a[@class='endnotecitation'][not(ancestor::span[@class='EndnoteReference'])]"/>
      <!-- End -->
     <!--To avoid the span[@class='EndnoteReference'] inside span[@class='EndnoteReference'] on 6-09-2022 -->
      <xsl:template match="span[@class='EndnoteReference'][descendant::span[@class='EndnoteReference']]/span[@class='EndnoteReference']">
            <xsl:apply-templates/>
      </xsl:template>
      <xsl:template match="span[@class='EndnoteReference' and @data-noendnoteref]/@data-noendnoteref"/>
      </xsl:stylesheet>
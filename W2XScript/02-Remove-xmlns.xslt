<!-- added to avoid field code formatting issue on 16-07-2021 -->
<!-- Added paragraph level content control on 09-11-2022 -->
<!-- Added for Editor to display the emptypara on 19-05-2023 -->
...
<xsl:character-map name="AsciiXX2Unicode">
<xsl:output-character character="┐" string="&amp;#x2510;"/>
<xsl:output-character character="╕" string="&amp;#x2556;"/>
<xsl:output-character character="╖" string="&amp;#x2557;"/>
<xsl:output-character character="╗" string="&amp;#x2555;"/>
...
<xsl:preserve-space elements="*"/>-->
<!-- To Remove white spaces, empty line breaks, trailing spaces -->
<!--added for endnote span inside span and fomatting on 21-09-2022-->
<xsl:template match="span[@class='EndnoteReference'][descendant::span[@class='EndnoteReference']]/descendant::span[@class='EndnoteReference']">
        <xsl:apply-templates/>
    </xsl:template>
<!-- Added paragraph level content control on 09-11-2022 -->
    <!-- ancestor::w:tbl or ancestor::w:endnote or ancestor::w:ftr or ancestor::v:shape or ancestor::w:object or ancestor::v:textbox or ancestor::w:pict or ancestor::v:formulas or ancestor::m:oMathPara or descendant::v:shape or descendant::w:object or descendant::v:textbox or descendant::w:pict or descendant::v:formulas or descendant::m:oMathPara -->
    <xsl:variable name="bkstart" select="//group/@StartBk"/>
    <xsl:template match="w:p[not(ancestor::w:tbl or ancestor::w:endnote or ancestor::w:ftr or ancestor::v:shape or ancestor::w:object or ancestor::v:textbox or ancestor::w:pict or ancestor::v:formulas or ancestor::m:oMathPara or ancestor::w:txbxContent or ancestor::w:drawing or ancestor::mc:AlternateContent)][descendant::w:bookmarkStart/@w:name]">
        <xsl:variable name="bkstart" select="//group[@StartBk = preceding::w:p[not(ancestor::w:tbl or ancestor::w:endnote or ancestor::w:ftr or ancestor::v:shape or ancestor::w:object or ancestor::v:textbox or ancestor::w:pict or ancestor::v:formulas or ancestor::m:oMathPara or ancestor::w:txbxContent or ancestor::w:drawing or ancestor::mc:AlternateContent)]//w:bookmarkStart/@w:name]/@Title"/>
        <xsl:variable name="bkmarkstart" select="self::w:p[not(ancestor::w:tbl or ancestor::w:endnote or ancestor::w:ftr or ancestor::v:shape or ancestor::w:object or ancestor::v:textbox or ancestor::w:pict or ancestor::v:formulas or ancestor::m:oMathPara or ancestor::w:txbxContent or ancestor::w:drawing or ancestor::mc:AlternateContent)]/descendant::w:bookmarkStart/@w:name"/>
        <xsl:variable name="bkmarkend1" select="following::w:p[not(ancestor::w:endnote or ancestor::w:ftr or ancestor::v:shape or ancestor::w:object or ancestor::v:textbox or descendant::v:textbox or ancestor::w:pict or ancestor::v:formulas or ancestor::m:oMathPara or ancestor::w:drawing or ancestor::mc:AlternateContent)]/descendant::w:bookmarkStart/@w:name"/>
        <xsl:variable name="bkmarkend2" select="self::w:p[not(ancestor::w:endnote or ancestor::w:ftr or ancestor::v:shape or ancestor::w:object or ancestor::v:textbox or descendant::v:textbox or ancestor::w:pict or ancestor::v:formulas or ancestor::m:oMathPara or ancestor::w:drawing or ancestor::mc:AlternateContent)]/descendant::w:bookmarkStart/@w:name"/>
        <xsl:for-each select="//group[not(contains(@EndBk,'footerpara'))][@EndBk = $bkmarkend1 or @EndBk = $bkmarkend2][@StartBk = $bkmarkstart]">
            <xsl:variable name="curr" select="@Title"/>
            <xsl:text disable-output-escaping="yes">&lt;w:sdt&gt;</xsl:text>
            <xsl:text disable-output-escaping="yes">&lt;w:sdtPr&gt;</xsl:text>
            <xsl:text disable-output-escaping="yes">&lt;w:alias w:val="</xsl:text>
            <xsl:value-of select="$curr"/>
            <xsl:text disable-output-escaping="yes">"/&gt;</xsl:text>
            <xsl:text disable-output-escaping="yes">&lt;/w:sdtPr&gt;</xsl:text>
            <xsl:text disable-output-escaping="yes">&lt;w:sdtContent&gt;</xsl:text>       
        </xsl:for-each>
        <xsl:copy>
        <xsl:apply-templates select="@*"/>
        ...
        <xsl:variable name="bkmarkstart1" select="preceding::w:p[not(ancestor::w:tbl or ancestor::w:endnote or ancestor::w:ftr or ancestor::v:shape or ancestor::w:object or ancestor::v:textbox or ancestor::w:pict or ancestor::v:formulas or ancestor::m:oMathPara or ancestor::w:txbxContent or ancestor::w:drawing or ancestor::mc:AlternateContent)]/descendant::w:bookmarkStart/@w:name"/>
        <xsl:variable name="bkmarkend" select="self::w:p[not(ancestor::w:tbl or ancestor::w:endnote or ancestor::w:ftr or ancestor::v:shape or ancestor::w:object or ancestor::v:textbox or descendant::v:textbox or ancestor::w:pict or ancestor::v:formulas or ancestor::m:oMathPara or ancestor::w:drawing or ancestor::mc:AlternateContent)]/descendant::w:bookmarkStart/@w:name"/>
        <xsl:for-each select="//group[not(contains(@EndBk,'footerpara'))][@StartBk = $bkmarkstart or @StartBk = $bkmarkstart1][@EndBk = $bkmarkend]">
            <xsl:text disable-output-escaping="yes">&lt;/w:sdtContent&gt;</xsl:text>
            <xsl:text disable-output-escaping="yes">&lt;/w:sdt&gt;</xsl:text>
        </xsl:for-each>
    </xsl:template>
    
    <xsl:template match="w:tbl[not(ancestor::v:textbox or ancestor::w:tbl)][w:tr/w:tc/w:p/descendant::w:bookmarkStart/@w:name]">
        
        <xsl:variable name="bkstart" select="//group[@StartBk = preceding::w:tbl//w:tr/w:tc/w:p/descendant::w:bookmarkStart/@w:name]/@Title"/>
        <xsl:variable name="bkmarkstart" select="self::w:tbl[not(ancestor::v:textbox or ancestor::w:tbl)]//w:tr/w:tc/w:p/descendant::w:bookmarkStart/@w:name"/>
        <xsl:variable name="bkmarkend1" select="self::w:tbl[not(ancestor::v:textbox or ancestor::w:tbl)]//w:tr/w:tc/w:p/descendant::w:bookmarkStart/@w:name"/>
        
        <xsl:for-each select="//group[not(contains(@EndBk,'footerpara'))][@EndBk = $bkmarkend1][@StartBk = $bkmarkstart]">
            <xsl:variable name="curr" select="@Title"/>           
            <xsl:text disable-output-escaping="yes">&lt;w:sdt&gt;</xsl:text>
            <xsl:text disable-output-escaping="yes">&lt;w:sdtPr&gt;</xsl:text>
            <xsl:text disable-output-escaping="yes">&lt;w:alias w:val="</xsl:text>
        ...
        <xsl:variable name="bkmarkend" select="self::w:tbl[not(ancestor::v:textbox or ancestor::w:tbl)]//w:tr/w:tc/w:p/descendant::w:bookmarkStart/@w:name"/>
        <xsl:for-each select="//group[not(contains(@EndBk,'footerpara'))][@StartBk = $bkmarkstart1 or @StartBk = $bkmarkstart][@EndBk = $bkmarkend]">
            <xsl:text disable-output-escaping="yes">&lt;/w:sdtContent&gt;</xsl:text>
            <xsl:text disable-output-escaping="yes">&lt;/w:sdt&gt;</xsl:text>
        </xsl:for-each>
    ...
    <xsl:template match="w:tbl[not(ancestor::v:textbox or ancestor::w:tbl)][w:tr/w:tc/w:p/descendant::w:bookmarkStart/@w:name]">
        <xsl:variable name="bkstart" select="//group[@StartBk = preceding::w:tbl[not(ancestor::v:textbox)]//w:tr/w:tc/w:p/descendant::w:bookmarkStart/@w:name]/@Title"/>
        <xsl:variable name="bkmarkstart" select="self::w:tbl//w:tr/w:tc/w:p/descendant::w:bookmarkStart/@w:name"/>
        <xsl:variable name="bkmarkend1" select="self::w:tbl[not(ancestor::v:textbox or ancestor::w:tbl)]//w:tr/w:tc/w:p/descendant::w:bookmarkStart/@w:name"/>
        <xsl:for-each select="//group[not(contains(@EndBk,'footerpara'))][@EndBk = $bkmarkend1][@StartBk = $bkmarkstart]">
            <xsl:variable name="curr" select="@Title"/>           
            <xsl:text disable-output-escaping="yes">&lt;w:sdt&gt;</xsl:text>
    ...
    <!-- end -->
    <!-- Footnotespace concept implemented by prakash on 7-12-2023 -->
    <xsl:template match="//w:footnote/w:p[descendant::w:bookmarkStart[@w:name = 'Remove-preceding-tags']]//w:r[not(descendant::w:bookmarkStart[@w:name = 'Remove-preceding-tags'])][not(preceding-sibling::w:r[descendant::w:bookmarkStart[@w:name = 'Remove-preceding-tags']])]/w:t">
    <xsl:element name="w:t">
    <xsl:choose>
    <xsl:when test="self::w:t[matches(normalize-space(.), '^([\s]+)$')]"><xsl:value-of select="replace(.,'^([\s]+)$','')"/></xsl:when>
    <xsl:otherwise><xsl:value-of select="replace(.,'^\s+','')"/></xsl:otherwise>
  </xsl:choose>
  </xsl:element>
    </xsl:template>
    <!--<xsl:template match="//w:footnote/w:p[1]//w:tab[ancestor::w:p/descendant::w:bookmarkStart[@w:name = 'Remove-preceding-tags']]">
        <xsl:choose>
            <xsl:when test="parent::w:r/not(preceding-sibling::w:bookmarkStart[@w:name = 'Remove-preceding-tags'])"/>
            <xsl:when test="parent::w:r/preceding-sibling::*[1][self::w:bookmarkStart[@w:name = 'Remove-preceding-tags']]"/>
            <xsl:otherwise>
                <xsl:copy>
                    <xsl:apply-templates select="@*"/>
                    <xsl:apply-templates select="node()"/>
    ...
    <xsl:template match="//w:footnote/w:p[descendant::w:bookmarkStart[@w:name = 'Remove-preceding-tags']]//w:tab[not(parent::w:r/parent::*/preceding-sibling::w:r[w:bookmarkStart[@w:name = 'Remove-preceding-tags']]|parent::w:r/preceding-sibling::w:r[w:bookmarkStart[@w:name = 'Remove-preceding-tags']])]"/>
        
    <!--<xsl:template match="//w:endnote/w:p[descendant::w:bookmarkStart[@w:name = 'Remove-preceding-tagsendnote']]//w:r[not(descendant::w:bookmarkStart[@w:name = 'Remove-preceding-tagsendnote'])][not(preceding-sibling::w:r[descendant::w:bookmarkStart[@w:name = 'Remove-preceding-tagsendnote']])]/w:t">
    <xsl:element name="w:t">
        <xsl:choose>
            <xsl:when test="self::w:t[matches(normalize-space(.), '^([\s]+)$')]"><xsl:value-of select="replace(.,'^([\s]+)$','')"/></xsl:when>
            <xsl:otherwise><!-\-<xsl:value-of select="."/>-\-><xsl:value-of select="replace(.,'^\s+','')"/></xsl:otherwise>
        </xsl:choose>
    </xsl:element>
    </xsl:template>-->
    <xsl:template match="//w:endnote/w:p[descendant::w:bookmarkStart[@w:name = 'Remove-preceding-tagsendnote']]//w:r[not(descendant::w:bookmarkStart[@w:name = 'Remove-preceding-tagsendnote'])][not(preceding-sibling::w:r[descendant::w:bookmarkStart[@w:name = 'Remove-preceding-tagsendnote']] or parent::*/preceding-sibling::w:r[descendant::w:bookmarkStart[@w:name = 'Remove-preceding-tagsendnote']])]/w:t">
        <xsl:element name="w:t">
            <xsl:choose>
                <xsl:when test="self::w:t[matches(normalize-space(.), '^([\s]+)$')]"><xsl:value-of select="replace(.,'^([\s]+)$','')"/></xsl:when>
                <xsl:otherwise><!--<xsl:value-of select="."/>--><xsl:value-of select="replace(.,'^\s+','')"/></xsl:otherwise>
    ...
    <xsl:template match="w:bookmarkStart[@w:name = 'Remove-preceding-tags']"/>
    <xsl:template match="w:bookmarkStart[@w:name = 'Remove-preceding-tagsendnote']"/>
    </xsl:stylesheet>
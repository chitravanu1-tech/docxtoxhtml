<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  <!--    <xsl:template match="span[@data-alias = 'ChapNo']">  
            <xsl:if test="descendant::span[@bkM-start]">
                  <xsl:copy-of select="descendant::span[@bkM-start]"/>  
            </xsl:if>
            <xsl:copy>
      ...
      <xsl:template match="span[@class = 'Figure'][not(descendant::span[@bkM-End])]">  
            <xsl:if test="descendant::span[@bkM-start]">
                  <xsl:copy-of select="descendant::span[@bkM-start]"/>  
            </xsl:if>
            <xsl:copy>
      ...
      <xsl:template match="span[@class = 'Figure'][descendant::span[@bkM-End]][not(descendant::span[@bkM-start])]">  
           <xsl:variable name="bkM" select="descendant::span/@bkM-End"/>            
            <xsl:copy>                  
                  <xsl:apply-templates select="@*"/>
                  <xsl:if test="ancestor::a/preceding-sibling::*[3][self::span[@bkM-start]/@bkM-Id = $bkM]">
                        <xsl:copy-of select="ancestor::a/preceding-sibling::*[3][self::span[@bkM-start]/@bkM-Id = $bkM]"/>  
                  </xsl:if>
                  <xsl:apply-templates select="node()"/>
            </xsl:copy>                      
      </xsl:template>
      -->
    <!--  <xsl:template match="span[@data-alias = 'SeqNo']">        
            <xsl:variable name="bkM-Start-ChapNo" select="ancestor::a[not(descendant::span[@class = 'ChapNo' or @class = 'ChapNo']/descendant::span[@bkM-End])]/descendant::span[@bkM-start]/@bkM-Id"/>
            ...
            <xsl:choose>
                  <xsl:when test="ancestor::a[descendant::span[@bkM-start]]/following-sibling::*[1][self::span[@bkM-End]]">
                        <xsl:copy-of select="ancestor::a/following-sibling::*[1][self::span[@bkM-End]]"/> 
                  </xsl:when>
                  <xsl:when test="ancestor::a[descendant::span[@bkM-start]]/following-sibling::*[2][self::span[@bkM-End]]">
                        <xsl:copy-of select="ancestor::a/following-sibling::*[2][self::span[@bkM-End]]"/>
                  </xsl:when>
                  <xsl:when test="ancestor::a[descendant::span[@bkM-start]]/following-sibling::*[3][self::span[@bkM-End = $bkM-Start-ChapNo]]">
                        <xsl:copy-of select="ancestor::a/following-sibling::*[3][self::span[@bkM-End]]"/> 
                  </xsl:when>
                  <xsl:when test="descendant::span[@bkM-End]">
                        <xsl:copy-of select="descendant::span[@bkM-End]"/> 
                  </xsl:when>
            </xsl:choose>
      </xsl:template>-->
      
     <!-- <xsl:template match="a[not(descendant::span[@data-alias = 'ChapNo'] | descendant::span[@data-alias = 'SeqNo'])][descendant::span[@bkM-start]][not(descendant::span[@bkM-End])]">
            <xsl:copy>
                  <xsl:apply-templates select="@*"/>
                  <xsl:apply-templates select="node()"/>
                  <xsl:if test="following-sibling::*[2][self::span[@bkM-End]]">
                        <xsl:copy-of select="following-sibling::*[2][self::span[@bkM-End]]"/>
                  </xsl:if>
            </xsl:copy> 
      </xsl:template>-->
     
  <!--    <xsl:template match="a[descendant::span[@bkM-End]][not(descendant::span[@bkM-start])]">         
           <xsl:copy>                             
                 <xsl:apply-templates select="@*"/>
                 <xsl:if test="preceding-sibling::*[1][self::span[@bkM-start]]">
                       <xsl:apply-templates select="preceding-sibling::*[1][self::span[@bkM-start]]"/>
                 </xsl:if>
                 <xsl:apply-templates select="node()"/>
           </xsl:copy>
     </xsl:template>
      <xsl:template match="a[@class = 'citationRef'][not(descendant::span[@bkM-End])]">    
            <xsl:if test="descendant::span[@bkM-start]">
                  <xsl:copy-of select="descendant::span[@bkM-start]"/>                        
            </xsl:if>
            <xsl:copy>                    
      ...
      <xsl:template match="a[@class = 'citationRef'][not(descendant::span[@bkM-start])]">   
            <xsl:copy>                    
                  <xsl:apply-templates select="@*"/>                 
                  <xsl:apply-templates select="node()"/>
            </xsl:copy>
            <xsl:if test="descendant::span[@bkM-End]">
                  <xsl:copy-of select="descendant::span[@bkM-End]"/>                        
            </xsl:if>
      </xsl:template>
      -->
      <xsl:template match="span[@bkM-start]">
            <xsl:choose>
                  <xsl:when test="following-sibling::a/descendant::span/@bkM-End = self::span/@bkM-Id">                       
                       <xsl:element name="span">
                           <xsl:attribute name="selfClose-bkM-start">
                               <xsl:value-of select="@bkM-start"/>
                           </xsl:attribute>
                           <xsl:if test="self::span[@bkM-Id]">
                              <xsl:attribute name="bkM-Id">
                                <xsl:value-of select="@bkM-Id"/>    
                              </xsl:attribute>
                           </xsl:if>
                       </xsl:element>                             
                  </xsl:when>
                  <xsl:when test="ancestor::a/following::span/@bkM-End = self::span/@bkM-Id">
                        <xsl:element name="span">
                              <xsl:attribute name="selfClose-bkM-start">
                                    <xsl:value-of select="@bkM-start"/>
                              </xsl:attribute>
                  ...
                  <xsl:when test="self::span[@bkM-Id = parent::span[1]/following::span/descendant::span/@bkM-End][parent::span/not(descendant::span/@bkM-End)]">
                        <xsl:element name="span">
                              <xsl:attribute name="selfClose-bkM-start">
                                    <xsl:value-of select="@bkM-start"/>
                              </xsl:attribute>
      ...
      <xsl:template match="span[@bkM-End]">
            <xsl:choose>
                  <xsl:when test="ancestor::a/preceding-sibling::span/@bkM-Id = self::span/@bkM-End">  
                        <xsl:element name="span">
                              <xsl:attribute name="selfClose-bkM-End">
                                    <xsl:value-of select="@bkM-End"/>
                              </xsl:attribute>
                        </xsl:element>                             
                  </xsl:when>
                  <xsl:when test="ancestor::a/preceding-sibling::a/descendant::span/@bkM-Id = self::span/@bkM-End">
                        <xsl:element name="span">
                              <xsl:attribute name="selfClose-bkM-End">
                                    <xsl:value-of select="@bkM-End"/>
                              </xsl:attribute>
                  ...
                  <xsl:when test="preceding-sibling::a/descendant::span[@bkM-start]/@bkM-Id = self::span/@bkM-End">
                        <xsl:element name="span">
                              <xsl:attribute name="selfClose-bkM-End">
                                    <xsl:value-of select="@bkM-End"/>
                              </xsl:attribute>
                  ...
                  <xsl:when test="self::span[@bkM-End = parent::span[1]/preceding::span/descendant::span/@bkM-Id][parent::span/not(descendant::span/@bkM-start)]">
                        <xsl:element name="span">
                              <xsl:attribute name="selfClose-bkM-End">
                                    <xsl:value-of select="@bkM-End"/>
                              </xsl:attribute>
     ...
     <xsl:template match="GROUP">
           <xsl:choose>
                 <xsl:when test="following-sibling::*[1][self::GROUP]">
                       <xsl:choose>
                             ...
                             <xsl:when test="child::two">
                                   ...
                                   <xsl:apply-templates/>
                                   <xsl:choose>
                                         <xsl:when test="following-sibling::*[1][self::GROUP/child::one]">
                                               <xsl:text disable-output-escaping="yes">&lt;/GROUP&gt;</xsl:text>
                                               <xsl:text disable-output-escaping="yes">&lt;/GROUP&gt;</xsl:text>
                             ...
                             <xsl:when test="child::three">
                                   ...
                                   <xsl:choose>
                                         ...
                                         <xsl:when test="following-sibling::*[1][self::GROUP/child::two]">
                                               <xsl:text disable-output-escaping="yes">&lt;/GROUP&gt;</xsl:text>
                                               <xsl:text disable-output-escaping="yes">&lt;/GROUP&gt;</xsl:text>
                             ...
                             <xsl:when test="child::four">
                                   ...
                                   <xsl:choose>
                                         ...
                                         <xsl:when test="following-sibling::*[1][self::GROUP/child::three]">
                                               <xsl:text disable-output-escaping="yes">&lt;/GROUP&gt;</xsl:text>
                                               <xsl:text disable-output-escaping="yes">&lt;/GROUP&gt;</xsl:text>
                                         </xsl:when>
                                         <xsl:otherwise/>
                             ...
                             <xsl:when test="child::five">
                                   ...
                                   <xsl:choose>
                                         ...
                                         <xsl:when test="following-sibling::*[1][self::GROUP/child::four]">
                                               <xsl:text disable-output-escaping="yes">&lt;/GROUP&gt;</xsl:text>
                                               <xsl:text disable-output-escaping="yes">&lt;/GROUP&gt;</xsl:text>
                                         </xsl:when>
                                         <xsl:otherwise/>
                             ...
                             <xsl:when test="child::six">
                                   ...
                                   <xsl:choose>
                                         ...
                                         <xsl:when test="following-sibling::*[1][self::GROUP/child::five]">
                                               <xsl:text disable-output-escaping="yes">&lt;/GROUP&gt;</xsl:text>
                                               <xsl:text disable-output-escaping="yes">&lt;/GROUP&gt;</xsl:text>
                                         </xsl:when>
                                         <xsl:otherwise/>
                             ...
                             <xsl:when test="child::seven">
                                   ...
                                   <xsl:choose>
                                         ...
                                         <xsl:when test="following-sibling::*[1][self::GROUP/child::six]">
                                               <xsl:text disable-output-escaping="yes">&lt;/GROUP&gt;</xsl:text>
                                               <xsl:text disable-output-escaping="yes">&lt;/GROUP&gt;</xsl:text>
                                         </xsl:when>
                                         <xsl:otherwise/>
                             ...
                             <xsl:when test="child::eight">
                                   ...
                                   <xsl:choose>
                                         ...
                                         <xsl:when test="following-sibling::*[1][self::GROUP/child::seven]">
                                               <xsl:text disable-output-escaping="yes">&lt;/GROUP&gt;</xsl:text>
                                               <xsl:text disable-output-escaping="yes">&lt;/GROUP&gt;</xsl:text>
                                         </xsl:when>
                                         <xsl:otherwise/>
                             ...
                             <xsl:when test="child::nine">
                                   ...
                                   <xsl:choose>
                                         ...
                                         <xsl:when test="following-sibling::*[1][self::GROUP/child::eight]">
                                               <xsl:text disable-output-escaping="yes">&lt;/GROUP&gt;</xsl:text>
                                               <xsl:text disable-output-escaping="yes">&lt;/GROUP&gt;</xsl:text>
                                         </xsl:when>
                                         <xsl:otherwise/>
                             ...
                             <xsl:when test="child::ten">
                                   ...
                                   <xsl:choose>
                                         ...
                                         <xsl:when test="following-sibling::*[1][self::GROUP/child::nine]">
                                               <xsl:text disable-output-escaping="yes">&lt;/GROUP&gt;</xsl:text>
                                               <xsl:text disable-output-escaping="yes">&lt;/GROUP&gt;</xsl:text>
                                         </xsl:when>
                                         <xsl:otherwise/>
                 ...
                 <xsl:otherwise>
                       <xsl:choose>                             
                             <xsl:when test="not(following-sibling::*[1][self::GROUP])">
                                   <xsl:choose>
                                         <xsl:when test="child::two">
                                               <xsl:copy>
                                                     <xsl:apply-templates select="@*|node()"/>                                          
           ...
           <xsl:choose>
                 <xsl:when test="preceding-sibling::*[1][self::GROUP] and following-sibling::*[1][self::GROUP]">   
                       <xsl:choose>
                             <xsl:when test="following-sibling::*[1][self::GROUP/one[@numberType != child::*[1][self::one/@numberType]]]">
                                   <xsl:text disable-output-escaping="yes">&lt;/GROUP&gt;</xsl:text>
                                   <xsl:text disable-output-escaping="yes">&lt;/GROUP&gt;</xsl:text>
                             </xsl:when>
                             <xsl:when test="following-sibling::*[1][self::GROUP/two[@numberType != child::*[1][self::two/@numberType]]]">
                                   <xsl:text disable-output-escaping="yes">&lt;/GROUP&gt;</xsl:text>
                                   <xsl:text disable-output-escaping="yes">&lt;/GROUP&gt;</xsl:text>
                             </xsl:when>
                             <xsl:when test="child::*[1][self::one] and preceding-sibling::*[1][self::GROUP/one]">
                                   <xsl:text disable-output-escaping="yes">&lt;/GROUP&gt;</xsl:text>
                                   <xsl:text disable-output-escaping="yes">&lt;/GROUP&gt;</xsl:text>
                             </xsl:when>
                       </xsl:choose>
                       <!--<xsl:if test="following-sibling::*[1][self::GROUP/one[@numberType != child::*[1][self::one/@numberType]]]">-->
                              <!--<xsl:text disable-output-escaping="yes">&lt;/GROUP&gt;</xsl:text>
                              <xsl:text disable-output-escaping="yes">&lt;/GROUP&gt;</xsl:text>-->
                       <!--</xsl:if>-->
                 </xsl:when>

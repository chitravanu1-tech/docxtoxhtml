<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  xmlns:p="http://www.machineedit.net/AMOD/CustomXML/ParaAttribute.htm"
...
<!-- Added paragraph level content control on 09-11-2022 -->
  ...
  <xsl:variable name="doc1" select="collection('./?select=item*.xml')//group[@data-contentcontrol='true']"/>
  <xsl:variable name="doc2" select="collection('./?select=item*.xml')//p:preedit"/>
  <xsl:template match="/">
    <xsl:copy>
      <xsl:apply-templates/>
    </xsl:copy>

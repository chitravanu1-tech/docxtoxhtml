...
for /R %%b IN (*.docx) DO (
 ...
 set filename="%%~nb"
 echo File: %%~nb
 REM start "" "\\10.1.1.100\Automation\WORDin\pe2XML\JoinTags\1.0.5\JoinTags.exe" "%CD%"
 rem "\\10.1.1.100\Automation\Perl\brl.exe" "\\10.1.1.100\automation\WORD2XML\Word2HTML5-EPUB\00-UNZIP.pl" "%%b"
 rem "C:\Perl\bin\perl.exe" "00-UNZIP.pl" "%%b"
...
pause
java -cp %CP% net.sf.saxon.Transform  -t -o:"math.xml" "%%~nf-out2.xml" "omml2mathml.xsl"
cls
echo 11111111111
pause
echo add
...
echo 1 list
java -cp %CP% net.sf.saxon.Transform -o:"dynamoIndex1.xml" "%%~nf-out4.xml" "01-Index_Creation-1.xslt"
java -cp %CP% net.sf.saxon.Transform -o:"dynamoIndex2.xml" "dynamoIndex1.xml" "01-Index_Creation-2.xslt"
java -cp %CP% net.sf.saxon.Transform -o:"dynamoIndex.xml" "dynamoIndex2.xml" "01-Index_Creation-3.xslt"
pause

...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
      ...
      <!-- 27-06-2023 below Badbreak concept added by prakash s because we got some <span> well formed issue's-->
            ...
            <xsl:choose>
                  <xsl:when test="child::*[1]">
                        ...
                        <xsl:variable name="numberFormat">                              
                              <xsl:choose>
                                    <xsl:when test="child::*[1]/@numberFormat">
                        ...
                        <!--<xsl:variable name="numberType" select="child::*[1]/@numberType"/>-->
                        ...
                        <!--<xsl:message>type: <xsl:value-of select="$listType"></xsl:value-of></xsl:message>-->
                        <xsl:choose>
                              <xsl:when test="contains($numberFormat, 'decimal')">
                                    <xsl:element name="ol">
                                          <xsl:attribute name="type">
                                                <xsl:choose>
                                                      <xsl:when test="contains($numberType, '&#x0025;')">
                                                            <xsl:value-of select="substring-after($numberType,'&#x0025;')"/>
                                                      </xsl:when>
                                                      <xsl:otherwise>
                                                            <xsl:value-of select="$numberType"/>
                                                      </xsl:otherwise>
                                          ...
                                          <!--<xsl:attribute name="class" select="$listType"/>   -->
                                          <xsl:attribute name="class">                                                
                                                <xsl:choose>
                                                      <xsl:when test="contains($numberType, '(') and contains($numberType, ')')">
                              ...
                              <xsl:when test="contains($numberFormat, 'bullet')">
                                    <xsl:element name="ul">
                                          ...
                                          <xsl:attribute name="class">                                                
                                                <xsl:choose>
                                                      <xsl:when test="contains($numberFormat, '(') and contains($numberFormat, ')')">
                                                            <xsl:text>opencloseParen</xsl:text>
                                                      </xsl:when>
                              ...
                              <xsl:when test="contains($listType, 'BulletList')">
                                    <xsl:element name="ol">
                                          <xsl:attribute name="type" select="'bullet'"/>                                         
                                          <xsl:apply-templates select="@*|node()"/>  
                                    </xsl:element>                                   
                              </xsl:when>
                              <xsl:when test="contains($listType, 'Lc-AlphaList')">
                                    <xsl:element name="ol">
                                          <xsl:attribute name="type" select="'numbered'"/>
                                          <xsl:attribute name="ENUM-TYPE" select="'loweralpha'"/>                                         
                                          <xsl:apply-templates select="@*|node()"/>  
                                    </xsl:element>                                   
                              </xsl:when>
                              <xsl:when test="contains($listType, 'Uc-AlphaList')">
                                    <xsl:element name="ol">
                                          <xsl:attribute name="type" select="'numbered'"/>
                                          <xsl:attribute name="ENUM-TYPE" select="'upperalpha'"/>                                         
                                          <xsl:apply-templates select="@*|node()"/>  
                                    </xsl:element>                                   
                              </xsl:when>
                              <xsl:when test="contains($listType, 'Uc-RomanList')">
                                    <xsl:element name="ol">
                                          <xsl:attribute name="type" select="'numbered'"/>
                                          <xsl:attribute name="ENUM-TYPE" select="'upperroman'"/>                                         
                                          <xsl:apply-templates select="@*|node()"/> 
                                    </xsl:element>                                   
                              </xsl:when>
                              <xsl:when test="contains($listType, 'Lc-RomanList')">
                                    <xsl:element name="ol">
                                          <xsl:attribute name="type" select="'numbered'"/>
                                          <xsl:attribute name="ENUM-TYPE" select="'lowerroman'"/>                                         
                                          <xsl:apply-templates select="@*|node()"/> 
                                    </xsl:element>                                   
                              </xsl:when>
                              <xsl:when test="contains($listType, 'NumberList')">
                                    <xsl:element name="ol">
                                          <xsl:attribute name="type" select="'numbered'"/>
                                          <xsl:attribute name="ENUM-TYPE" select="'arabicnum'"/>                                         
                                          <xsl:apply-templates select="@*|node()"/> 
                                    </xsl:element>                               
                              </xsl:when>
                              <xsl:when test="contains($listType, 'dummy')">
                                    <xsl:element name="ol">
                                          <xsl:attribute name="type" select="'dummy'"/>
                                          <xsl:attribute name="ENUM-TYPE" select="'dummy'"/>                                         
                                          <xsl:apply-templates select="@*|node()"/> 
                                    </xsl:element>                                   
                              </xsl:when>
                              <xsl:otherwise>
                                    <xsl:element name="ol">
                                          <xsl:attribute name="id" select="'RemoveListnumber'"/>
                                          <xsl:attribute name="type" select="'nolist'"/>
                                          <xsl:attribute name="ENUM-TYPE" select="'nolist'"/>                                         
                                          <xsl:apply-templates select="@*|node()"/> 
                                    </xsl:element>  
      ...
      <xsl:template match="one|two|three|four|five|six|seven|eight|nine|ten">
            <xsl:if test="not(@listtype = 'dummy')">
                  <xsl:element name="li">
                        <xsl:attribute name="class" select="translate(@listtype,' _-','')"/>
     ...
     <xsl:template match="groupX|GROUPx">
           <xsl:choose>
                 <xsl:when test="child::*[1]">
                       <xsl:variable name="listType" select="child::*[1]/@listtype"/>
                       <xsl:variable name="numberFormat" select="child::*[1]/@numberFormat"/>
      ...
      <!--<xsl:template match="one|two|three|four|five|six|seven|eight|nine|ten">
            <xsl:choose>
                  <xsl:when test="preceding-sibling::*[1][self::GROUP]">
                        ...
                        <xsl:choose>
                              <xsl:when test="following-sibling::*[1][self::one|two|three|four|five|six|seven|eight|nine|ten]">
                  ...
                  <xsl:when test="following-sibling::*[1][self::one]">
                        <xsl:element name="li">
                              <xsl:attribute name="class" select="@listtype"/>
                                    <xsl:apply-templates/>                              
                        </xsl:element>
                  </xsl:when>
                  <xsl:when test="following-sibling::*[1][self::two]">
                        <xsl:element name="li">
                              <xsl:attribute name="class" select="@listtype"/>
                                    <xsl:apply-templates/>                              
                        </xsl:element>
                  </xsl:when>
                  <xsl:when test="following-sibling::*[1][self::three]">
                        <xsl:element name="li">
                              <xsl:attribute name="class" select="@listtype"/>
                                    <xsl:apply-templates/>                              
                        </xsl:element>
                  </xsl:when>
                  <xsl:when test="following-sibling::*[1][self::four]">
                        <xsl:element name="li">
                              <xsl:attribute name="class" select="@listtype"/>
                                    <xsl:apply-templates/>                              
                        </xsl:element>
  ...
  <!-- 16-Jan-18; Remove vmerge p tag. (<tr><p><span>...</span></p><td>.... to <tr><span/><td>)-->
      <!-- 16-Jan-18; Then see next XSLT-->
      <xsl:template match="p[parent::tr]">
            <xsl:apply-templates/>
      </xsl:template>
  <!-- 16-Jan-18; Remove vmerge p tag. (<tr><p>...</p><td>.... )-->
...
<xsl:output-character character=" " string="&amp;#x2029;"/>
      ...
      <!--Added two styles applied for same url issue on on 12-5-2022-->
      <!-- aDDED TO AVOID THE VALIDATION ISSUE INSIDE DEL AND INS ON 14-10-2024 -->
      <!-- Added to ignore the  wellformed issue on 20-02-2025-->
      <!-- ancestor::del or ancestor::ins for Ng file not ran issue on 07-04-2025 -->
      <xsl:template match="span[contains(@data-bkmark,'URL')][not(parent::del or parent::ins or ancestor::del or ancestor::ins)][@data-bkmark = following::span[@data-urlstart='End'][not(parent::del or parent::ins or ancestor::del or ancestor::ins)]/@data-bkmark][@data-urlstart='start']">
            <xsl:element name="span">
            ...
            <xsl:text disable-output-escaping="yes">" data-urlstart="start"&gt;</xsl:text>
      </xsl:template>
      <xsl:template match="span[contains(@data-bkmark,'URL')][not(parent::del or parent::ins or ancestor::del or ancestor::ins)][@data-bkmark = preceding::span[@data-urlstart='start'][not(parent::del or parent::ins or ancestor::del or ancestor::ins)]/@data-bkmark][@data-urlstart='End']">
      ...
      <!-- 27-06-2023 below Badbreak concept added by prakash s because we got some <span> well formed issue's-->
      <!-- Added to avoid the ins inside bb open outside close and viseversa on 24-06-2025  Azure 18654-->
      <xsl:template match="span[@bkM-start][not(parent::del or parent::ins)][@bkM-Id = following::span[@bkM-End][not(parent::del or parent::ins)]/@bkM-End]">
      <xsl:text disable-output-escaping="yes">&lt;span style="white-space: nowrap;"&gt;</xsl:text>
      </xsl:template>
      <xsl:template match="span[@bkM-End][not(parent::del or parent::ins)][@bkM-End = preceding::span[@bkM-start][not(parent::del or parent::ins)]/@bkM-Id]">
            <xsl:text disable-output-escaping="yes">&lt;/span&gt;</xsl:text>
      </xsl:template>
      <xsl:template match="span[@bkM-start][parent::del or parent::ins]">
            <xsl:text disable-output-escaping="yes">&lt;span style="white-space: nowrap;"&gt;&lt;/span&gt;</xsl:text>
      </xsl:template>
      <xsl:template match="span[@bkM-End][parent::del or parent::ins]">
            <xsl:text disable-output-escaping="yes">&lt;span style="white-space: nowrap;"&gt;&lt;/span&gt;</xsl:text>
      </xsl:template>
      <xsl:template match="span[@selfClose-bkM-start]">
            <xsl:text disable-output-escaping="yes">&lt;span style="white-space: nowrap;"&gt;&lt;/span&gt;</xsl:text>
      </xsl:template>
      <xsl:template match="span[@selfClose-bkM-End]">
            <xsl:text disable-output-escaping="yes">&lt;span style="white-space: nowrap;"&gt;&lt;/span&gt;</xsl:text>
      </xsl:template>   

...
<!-- 15-June-17: added attribute "data-split" for the elements asked by Mariappan-->
    ...
    <!--<xsl:template match="span[@class = 'MsoEndnoteReference']">
        <xsl:variable name="endnote-id" select="parent::a/@style"/>
...
<xsl:output-character character=" " string="&amp;#x2029;"/>
    ...
    <!-- @@@@@@@@@@@@@@@@ -->
    <!-- 24-oct-18: Added No-B-IT property Sindhu -->  
    <xsl:template match="span[@data-Bold]">
        <xsl:choose>
            <xsl:when test="not(child::b)">
                <xsl:apply-templates/><xsl:message>hi</xsl:message>
            </xsl:when>
            <xsl:otherwise>
                <xsl:element name="span">
                    <xsl:attribute name="data-Bold" select="'REMOVE'"/>
    ...
    <xsl:template match="span[@data-Italic]">
        <xsl:choose>
            <xsl:when test="not(child::i)">
                <xsl:apply-templates/>
            </xsl:when>
            <xsl:otherwise>
                <xsl:element name="span">
    ...
    <xsl:template match="span[@data-Underline]">
        <xsl:choose>
            <xsl:when test="not(child::u)">
                <xsl:apply-templates/>
            </xsl:when>
            <xsl:otherwise>
                <xsl:element name="span">

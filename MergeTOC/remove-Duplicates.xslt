...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:output indent="no" use-character-maps="Ascii2Unicode"/>
    <xsl:output method="xml"/>
    <xsl:param name="allSpaceCharacterEntity"
        select="'&#8232;|&#x0020;|&#xa0;|&#x00A0;|&#xA;|&#x9;|&#x2028;|&#8194;|&#8195;|&#x00009;|&#x0000A;|&#x02002;|&#x02003;|&#x02004;|&#x02005;|&#x02007;|&#x02008;|&#x02009;|&#x0200A;|&#x0200B;|&#x0200C;|&#x0200D;|&#x0200E;|&#x0200F;|&#x0205F;|&#x02060;|&#x02061;|&#x02062;|&#x02063;|&#x000AD;|&#x000A0;|&#65279;|&#xfeff;|&#x202F;|&#x200c;|&#65533;'"/>
    <!-- Added to remove empty on 25-1-2022 -->
...
<!-- <xsl:template match="div/p">
     <xsl:choose>
          <xsl:when test="not(self::p/lower-case(.) = following-sibling::p/lower-case(.))">
<!-\-         <xsl:when test="not(self::p/. = self::p/following::p/.)">-\->
             <xsl:copy>
 ...
 <xsl:template match="span[matches(@class,'pageno-')]">    
    ...
    <xsl:template match="span[@class = 'uppercase']">
        <xsl:copy>
            <xsl:apply-templates select="@*"/>
 ...
 <xsl:template match="b">
    ...
    <!-- 11-06-2024 commented for if multiple titles comes then we need to retaine for example cicerone book of 1089 BRECON BEACONS-->
   <!-- <xsl:template match="div/p[@class = 'TOC_ChapterNumber'][preceding-sibling::*[self::p[@class = 'TOC_ChapterTitle']]]"/>
    <xsl:template match="div/p[@class = 'TOC_ChapterTitle'][preceding-sibling::*[self::p[@class = 'TOC_ChapterTitle']]]"/>
    <xsl:template match="div/p[@class = 'SubTitle'][preceding-sibling::*[self::p[@class = 'TOC_ChapterTitle']]]"/>-->
    
         
    <xsl:template match="p[not(string-length(translate(.,$allSpaceCharacterEntity,'')) &gt; 0)]"/>
    
    <!--<xsl:template match="p[@class = 'TOC_PartNumber'][following-sibling::*[1][self::p[@class = 'TOC_PartTitle']]]"/>
    <xsl:template match="p[@class = 'TOC_UnitNumber'][following-sibling::*[1][self::p[@class = 'TOC_UnitTitle']]]"/>
    <xsl:template match="p[@class = 'TOC_SectionNumber'][following-sibling::*[1][self::p[@class = 'TOC_SectionTitle']]]"/>
    <xsl:template match="p[@class = 'TOC_ChapterNumber'][following-sibling::*[1][self::p[@class = 'TOC_ChapterTitle']]]"/>
    <xsl:template match="p[@class = 'TOC_ChapterNumber'][following-sibling::*[1][self::p[@class = 'TOC_BackMatter']]]"/>-->
    
    <xsl:template match="p[matches(@class/lower-case(.), 'number')][following-sibling::*[1][self::p[@toc = 'true']]]"/>
        
    <xsl:template match="text()">
        <xsl:choose>
            <xsl:when test="matches(.,'&lt;span&gt;position-')">
                <xsl:value-of select="substring-before(.,'&lt;span&gt;position-')"/>
            </xsl:when>

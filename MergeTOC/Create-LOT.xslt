...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:template match="/">
        <xsl:if test="descendant::body[child::p[@class = 'TOC_TableCaption']][string-length(.) &gt; 0]">
            <xsl:result-document href="{'Tables'}.xhtml">
                <xsl:element name="html">
                    <xsl:element name="head">
                        <xsl:text>&#x000A;</xsl:text>
                        <xsl:element name="title">
                            <xsl:value-of select="'List of Tables'"/>
                        </xsl:element>
                        <xsl:text>&#x000A;</xsl:text>
...
<!--                        <xsl:element name="div">-->
                            ...
                            <xsl:element name="p"><xsl:attribute name="class"><xsl:value-of select="$getFrontMatterHeadingClientStyle"/></xsl:attribute><xsl:attribute name="data-name"><xsl:value-of select="$getFrontMatterHeadingClientStyle"/></xsl:attribute>List of Tables</xsl:element>
                            <xsl:element name="div">
                        <xsl:for-each select="//p[@class = 'TOC_TableCaption']">

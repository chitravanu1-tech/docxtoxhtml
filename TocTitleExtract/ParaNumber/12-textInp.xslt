...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:template match="Spread">
        <xsl:element name="Measurement">
            ...
            <xsl:apply-templates select="Polygon | Rectangle | Oval | GraphicLine | Oval[descendant::TextPath[@ParentStory]] | Polygon[descendant::TextPath[@ParentStory]] |  GraphicLine[descendant::TextPath[@ParentStory]]"/>
    ...
    <xsl:template match="TextFrame" name="TF">
        ...
        <xsl:variable name="Halfheight">
          ...
          <xsl:element name="TextFrame">
                ...
                <xsl:attribute name="ObjectStyle" select="@AppliedObjectStyle"/>
            ...
            <xsl:attribute name="pageNo_rowman_2_int">
                <xsl:choose>
                    <xsl:when test="not(matches($pageNo,'^\d+$'))">
                        ...
                        <xsl:value-of select="$RomanIntVal"/>
                    </xsl:when>
                    <xsl:otherwise>
    ...
    <xsl:template match="Polygon | Rectangle | Oval | GraphicLine | Oval[descendant::TextPath[@ParentStory]] | Rectangle[descendant::TextPath[@ParentStory]] | Polygon[descendant::TextPath[@ParentStory]] | GraphicLine[descendant::TextPath[@ParentStory]]">
        ...
        <xsl:variable name="AppliedObjectStyle" select="@AppliedObjectStyle[lower-case(.) = 'objectstyle/map-key']/.[string-length(.) &gt; 0]"/>
            ...
            <xsl:element name="{$elementName}">
                ...
                <xsl:if test="self::*/Image">
                    <xsl:variable name="link">                        
                        <!--13-06-2024 commented for cicerone book of 1089 BRECON BEACONS becasue image path comes with tag's Rectangle | Oval | Polygon | GraphicLine  -->
                        <!--  <xsl:variable name="local" select="tokenize(self::Rectangle/Image/Link/@LinkResourceURI,'/')[last()]"/>-->
                        <xsl:variable name="local">
                            <xsl:if test="tokenize(self::Rectangle//Link/@LinkResourceURI,'/')[last()]">
                                <xsl:value-of select="tokenize(self::Rectangle//Link/@LinkResourceURI,'/')[last()]"/>
                            </xsl:if>
                            <xsl:if test="tokenize(self::Oval//Link/@LinkResourceURI,'/')[last()]">
                                <xsl:value-of select="tokenize(self::Oval//Link/@LinkResourceURI,'/')[last()]"/>
                            </xsl:if>
                            <xsl:if test="tokenize(self::Polygon//Link/@LinkResourceURI,'/')[last()]">
                                <xsl:value-of select="tokenize(self::Polygon//Link/@LinkResourceURI,'/')[last()]"/>
                            </xsl:if>
                            <xsl:if test="tokenize(self::GraphicLine//Link/@LinkResourceURI,'/')[last()]">
                                <xsl:value-of select="tokenize(self::GraphicLine//Link/@LinkResourceURI,'/')[last()]"/>
                            </xsl:if>                            
                        </xsl:variable>
...
<!--                        <xsl:variable name="local" select="self::Rectangle/Image/Link/@LinkResourceURI"/> -->
                        <xsl:variable name="local">
                            <xsl:if test="self::Rectangle//Link/@LinkResourceURI">
                                <xsl:value-of select="self::Rectangle//Link/@LinkResourceURI"/>
                            </xsl:if>
                            <xsl:if test="self::Oval//Link/@LinkResourceURI">
                                <xsl:value-of select="self::Oval//Link/@LinkResourceURI"/>
                            </xsl:if>
                            <xsl:if test="self::Polygon//Link/@LinkResourceURI">
                                <xsl:value-of select="self::Polygon//Link/@LinkResourceURI"/>
                            </xsl:if>
                            <xsl:if test="self::GraphicLine//Link/@LinkResourceURI">
                                <xsl:value-of select="self::GraphicLine//Link/@LinkResourceURI"/>
                            </xsl:if>
                        </xsl:variable>
                        <xsl:value-of select="replace($local,'%20',' ')"/>
                    </xsl:variable>
...
<!--                        <xsl:variable name="local" select="self::Rectangle/EPS/Link/@LinkResourceURI"/>-->
                ...
                <!--13-06-2024 added for cicerone book of 1089 BRECON BEACONS becasue image path comes with tag's Rectangle | Oval | Polygon | GraphicLine  -->
                <xsl:if test="self::*/WMF">
                    <xsl:variable name="link">                     
                        <xsl:variable name="local">
                            <xsl:if test="self::Rectangle//Link/@LinkResourceURI">
...
<!--                        <xsl:variable name="local" select="self::Rectangle/PDF/Link/@LinkResourceURI"/>-->
                ...
                <xsl:if test="string-length($AppliedObjectStyle) &gt; 0">
                    <xsl:attribute name="ObjectStyle" select="$AppliedObjectStyle"/>
                </xsl:if>
                <xsl:choose>
                    <xsl:when test="parent::Group">

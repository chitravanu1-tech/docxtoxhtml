...
<!--                      <xsl:if test="self::CharacterStyleRange/@FillColor">-->
           ...
           <!-- <xsl:call-template name="AllNestedStyles">
                  <xsl:with-param name="nestedStylesVal"/>
            </xsl:call-template>-->
    ...
    <xsl:template match="ParagraphStyle">
        ...
        <xsl:element name="w:style">
           ...
           <!-- <xsl:choose>
            ...
            <!--<xsl:if test="@DropCapLines">
                <xsl:attribute name="w:dropcapL">
                    <xsl:value-of select="@DropCapLines"/>
                </xsl:attribute>
            </xsl:if>-->
...
<!--                                        <xsl:if test="@Name = $styleName">-->
                       ...
                       <!-- <xsl:choose>
                        ...
                        <!--<xsl:if test="child::Properties/Leading">                         
                             <xsl:element name="w:leading">
                                 <xsl:attribute name="w:val" select="child::Properties/Leading"/>
                             </xsl:element>
                        </xsl:if>-->
                </xsl:if>
...
<!--                    <xsl:if test="contains(@FontStyle,'Black') or contains(@FontStyle,'Bold') or contains(@FontStyle,'Strong') or contains(@FontStyle,'black') or contains(@FontStyle,'bold') or contains(@FontStyle,'strong') or contains(@FontStyle,'Extra') or contains(@FontStyle,'extra') or contains(@FontStyle,'Heavy') or contains(@FontStyle,'heavy') ">-->
    ...
    <!--<xsl:template name="AllNestedStyles">
        <xsl:param name="nestedStylesVal"/>

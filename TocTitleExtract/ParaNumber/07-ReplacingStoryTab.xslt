...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:template match="Rectangle">
        ...
        <xsl:variable name="PPT1" select="((self::Rectangle/Properties/PathGeometry/GeometryPathType/PathPointArray/PathPointType[1]/@Anchor))"/>
        <xsl:variable name="PPT2" select="((self::Rectangle/Properties/PathGeometry/GeometryPathType/PathPointArray/PathPointType[2]/@Anchor))"/>
        <xsl:variable name="PPT3" select="((self::Rectangle/Properties/PathGeometry/GeometryPathType/PathPointArray/PathPointType[3]/@Anchor))"/>
        <xsl:variable name="PPT4" select="((self::Rectangle/Properties/PathGeometry/GeometryPathType/PathPointArray/PathPointType[4]/@Anchor))"/>

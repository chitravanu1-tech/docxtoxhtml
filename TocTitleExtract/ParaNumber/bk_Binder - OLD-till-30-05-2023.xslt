...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
        ...
        <xsl:result-document href="{'output1'}.cf">
            ...
            <xsl:element name="root">
                ...
                <xsl:element name="Title">
                    ...
                    <xsl:call-template name="chapterHeads">
                        <xsl:with-param name="chTHeadsVal"/>
                    </xsl:call-template>
    ...
    <xsl:template name="chapterTitle">
        ...
        <xsl:choose>
            <xsl:when
                test="descendant::ParagraphStyleRange[@AppliedParagraphStyle = 'ParagraphStyle/FrontMatterHeading'] | descendant::ParagraphStyleRange[@AppliedParagraphStyle = 'ParagraphStyle/ChapterTitle'] | descendant::ParagraphStyleRange[@AppliedParagraphStyle = 'ParagraphStyle/BackMatterHeading'] | descendant::ParagraphStyleRange[@AppliedParagraphStyle = 'ParagraphStyle/FB_IndexHeading']">
                <xsl:for-each
                    ...
                    <xsl:choose>
                        ...
                        <xsl:when
                            test="self::ParagraphStyleRange[@AppliedParagraphStyle = 'ParagraphStyle/ChapterTitle'] | self::ParagraphStyleRange[@AppliedParagraphStyle = 'ParagraphStyle/BackMatterHeading'] | self::ParagraphStyleRange[@AppliedParagraphStyle = 'ParagraphStyle/FB_IndexHeading']">
                            <xsl:variable name="chapterTitle">
                                <xsl:for-each select="descendant-or-self::Content">
                                    <xsl:value-of select="."/>
                                </xsl:for-each>
                            ...
                            <xsl:choose>
                                ...
                                <xsl:when
                                    test="count(self::ParagraphStyleRange[@AppliedParagraphStyle = 'ParagraphStyle/ChapterTitle'] | self::ParagraphStyleRange[@AppliedParagraphStyle = 'ParagraphStyle/BackMatterHeading'] | self::ParagraphStyleRange[@AppliedParagraphStyle = 'ParagraphStyle/FB_IndexHeading']) = 1 and $count = 1">
                                    <xsl:variable name="attName">
                                        <xsl:value-of select="'ChapterTitle'"/>
                                    </xsl:variable>
            ...
            <xsl:when
                test="descendant::ParagraphStyleRange[@AppliedParagraphStyle = 'ParagraphStyle/FB_Half_Title']">
                <xsl:for-each
                    select="descendant::ParagraphStyleRange[@AppliedParagraphStyle = 'ParagraphStyle/FB_Half_Title']">
                    <xsl:choose>
                        <xsl:when
                            test="self::ParagraphStyleRange[@AppliedParagraphStyle = 'ParagraphStyle/FB_Half_Title']">
                            <xsl:variable name="copyright"
                                select="self::ParagraphStyleRange[@AppliedParagraphStyle = 'ParagraphStyle/FB_Half_Title']"/>
            ...
            <xsl:when
                test="descendant::ParagraphStyleRange[@AppliedParagraphStyle = 'ParagraphStyle/FB_Series_Title']">
                <xsl:for-each
            ...
            <xsl:when
                test="descendant::ParagraphStyleRange[@AppliedParagraphStyle = 'ParagraphStyle/FB_Book_Title']">
                <xsl:for-each
            ...
            <xsl:when
                test="descendant::ParagraphStyleRange[@AppliedParagraphStyle = 'ParagraphStyle/FB_Copy_Right_First']">
                <xsl:for-each
            ...
            <xsl:when
                test="descendant::ParagraphStyleRange[@AppliedParagraphStyle = 'ParagraphStyle/FB_DedicationPara']">
                <xsl:for-each
                    select="descendant::ParagraphStyleRange[@AppliedParagraphStyle = 'ParagraphStyle/FB_DedicationPara']">
                    <xsl:choose>
                        <xsl:when
            ...
            <xsl:when
                test="descendant::ParagraphStyleRange[@AppliedParagraphStyle = 'ParagraphStyle/Epigraph']">
                <xsl:for-each
    ...
    <xsl:template name="chapterNumber">
        ...
        <xsl:for-each select="descendant::ParagraphStyleRange[@AppliedParagraphStyle = 'ParagraphStyle/ChapterNumber']">
            <xsl:choose>
                ...
                <xsl:when
                    test="self::ParagraphStyleRange[@AppliedParagraphStyle = 'ParagraphStyle/ChapterNumber']/CharacterStyleRange[@AppliedCharacterStyle = 'CharacterStyle/ChapterWord'] or self::ParagraphStyleRange[@AppliedParagraphStyle = 'ParagraphStyle/ChapterNumber']/CharacterStyleRange[@AppliedCharacterStyle = 'CharacterStyle/ChapterNumber']">
...
<!--                        <xsl:value-of select="normalize-space(translate(., '&#x9;|&#xA;|&#8232;|&#x00AD;', ''))"/>  -->
    ...
    <xsl:template name="chapterHeads">
        <xsl:param name="chTHeadsVal"/>

       <!-- <xsl:for-each select="descendant::ParagraphStyleRange[@AppliedParagraphStyle = 'ParagraphStyle/Head1']">
            <xsl:choose>
                <xsl:when test="self::ParagraphStyleRange[@AppliedParagraphStyle = 'ParagraphStyle/Head1']">
                    <xsl:variable name="chapterTitle">
                        <xsl:for-each select="descendant-or-self::Content">
                            <xsl:value-of select="."/>
                        </xsl:for-each>
        ...
        <xsl:for-each select="descendant::ParagraphStyleRange[@toc = 'true']">
            ...
            <!--<xsl:message><xsl:value-of select="."/> = <xsl:value-of select="following::ParagraphStyleRange[@toc = 'true']/."/></xsl:message>-->
<!--            <xsl:if test="not(. = following::ParagraphStyleRange[@toc = 'true']/.)">-->
            <xsl:choose>
                <xsl:when test="self::ParagraphStyleRange[@toc = 'true']">
                    <xsl:variable name="chapterTitle">
                        <!--<xsl:for-each select="descendant-or-self::Content">
                            <xsl:value-of select="."/>
                        </xsl:for-each>-->
...
<!--                                <xsl:value-of select="concat(self::ParagraphStyleRange/@AppliedParagraphStyle/substring-after(.,'ParagraphStyle/'),'-', position(),'_p',$find-pNo)"/>-->
                                ...
                                <xsl:value-of select="concat(self::ParagraphStyleRange/@AppliedParagraphStyle/substring-after(.,'ParagraphStyle/'),'-',$UUID)"/>
...
<!-- Added to merge subtitle on 22-12-2022-->
    <xsl:template name="PartTitle">
        ...
        <xsl:for-each
            select="descendant::ParagraphStyleRange[@AppliedParagraphStyle = 'ParagraphStyle/PartTitle']">
            <xsl:choose>
                <xsl:when
                    test="self::ParagraphStyleRange[@AppliedParagraphStyle = 'ParagraphStyle/PartTitle']">
    ...
    <xsl:template name="find_For_External_Link">
        ...
        <xsl:choose>
            <xsl:when
                test="descendant::ParagraphStyleRange[@AppliedParagraphStyle = 'ParagraphStyle/TableCaption']">
            ...
            <xsl:when
                test="descendant::ParagraphStyleRange[@AppliedParagraphStyle = 'ParagraphStyle/FigureLegend']">
                <xsl:attribute name="figures">

                    <xsl:for-each
                        select="descendant::ParagraphStyleRange[@AppliedParagraphStyle = 'ParagraphStyle/FigureLegend']">
                        <xsl:analyze-string select="."
        ...
        <xsl:for-each select="descendant-or-self::CharacterStyleRange[not(contains(@AppliedCharacterStyle,'endnotereference') or contains(@AppliedCharacterStyle,'endnote reference') or contains(@AppliedCharacterStyle,'footnoteReference') or contains(lower-case(@AppliedCharacterStyle),'footnotereference') or contains(lower-case(@AppliedCharacterStyle),'footnote reference'))]">
            ...
            <xsl:choose>
                <xsl:when test="contains($Charstyle0, 'smallcaps') or contains($Charstyle0, 'allcaps') or @Underline = 'true' or StrikeThru = 'true' or contains($Charstyle0, 'heavy') or contains($Charstyle0, 'bold') or contains($Charstyle0, 'italic') or contains($Charstyle0, 'oblique') or contains($Charstyle0, 'subscript') or contains($Charstyle0, 'superscript') or $Charstyle0='sup' or $Charstyle0='sub'">
                    ...
                    <xsl:if
                        test="contains($Charstyle0, 'bold') or contains($Charstyle0, 'medium') or contains($Charstyle0, 'heavy')">
                        <xsl:text disable-output-escaping="yes">&lt;</xsl:text>
                        <xsl:value-of select="'b'"/>
                        <xsl:text disable-output-escaping="yes">&gt;</xsl:text>
                    </xsl:if>
                    <xsl:if
                        test="contains($Charstyle0, 'italic') or contains($Charstyle0, 'oblique')">
                        <xsl:text disable-output-escaping="yes">&lt;</xsl:text>

...
<!--        <xsl:result-document href="output2/nestedChar.xslt">-->
            <xsl:result-document href="09-nestedChar.xslt">
        ...
        <xsl:for-each select="descendant::Table">
            ...
            <xsl:variable name="bookmark">
                <xsl:choose>
                    ...
                    <xsl:when
                        test="descendant::HyperlinkTextDestination[1][contains(lower-case(@BookMarkDestination), '_story_')]">
                        <xsl:value-of
                            select="descendant::HyperlinkTextDestination[1][contains(lower-case(@BookMarkDestination), '_story_')]/@BookMarkDestination"
                        />
                    </xsl:when>
                    <xsl:when
                        test="descendant::HyperlinkTextSource[1][contains(lower-case(@bkmark), '_story_')]">
                        <xsl:value-of
                            select="descendant::HyperlinkTextSource[1][contains(lower-case(@bkmark), '_story_')]/@bkmark"
                        />
                    </xsl:when>
                    <xsl:when
                        test="descendant::HyperlinkTextDestination[1][contains(lower-case(@bkmark), '_story_')]">
                        <xsl:value-of
                            select="descendant::HyperlinkTextDestination[1][contains(lower-case(@bkmark), '_story_')]/@bkmark"
                        />
                    </xsl:when>
                </xsl:choose>
            </xsl:variable>

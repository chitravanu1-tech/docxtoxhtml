  ...
  <xsl:template match="ParagraphStyleRange">  
          <xsl:variable name="Na1">
            ...
            <xsl:element name="w:p">  
                ...
                <xsl:for-each select="descendant::HyperlinkTextDestination[contains(@BookMarkDestination,'FTXID')] | descendant::HyperlinkTextSource[contains(lower-case(@HyperlinkUDestination),'FTXID')]">
                    ...
                    <xsl:variable name="HUD">
                        ...
                        <xsl:choose>
                            <xsl:when test="contains(self::HyperlinkTextSource[contains(lower-case(@HyperlinkUDestination),'_story_')]/@HyperlinkUDestination | self::HyperlinkTextDestination[contains(lower-case(@BookMarkDestination),'_story_')]/@BookMarkDestination,'_TX_')">
                                <xsl:choose>
                                    ...
                                    <xsl:when test="self::HyperlinkTextDestination[contains(lower-case(@BookMarkDestination),'_story_')]/@BookMarkDestination">
                            ...
                            <xsl:when test="not(contains(self::HyperlinkTextSource/@HyperlinkUDestination | self::HyperlinkTextDestination/@BookMarkDestination,'_TX_'))">
                                <xsl:choose>
                                    ...
                                    <xsl:when test="self::HyperlinkTextDestination[contains(lower-case(@BookMarkDestination),'_story_')]/@BookMarkDestination">
                                        <xsl:value-of select="self::HyperlinkTextDestination[contains(lower-case(@BookMarkDestination),'_story_')]/@BookMarkDestination"/>
                                    </xsl:when>
                                </xsl:choose>
                            </xsl:when>
                        </xsl:choose>
                ...
                <xsl:for-each select="descendant::HyperlinkTextDestination[contains(@BookMarkDestination,'FTXID')][1] | descendant::HyperlinkTextSource[contains(lower-case(@HyperlinkUDestination),'FTXID')][1]">
                    <xsl:variable name="id">
                        <xsl:number level="any"/>
                    </xsl:variable>
                    <xsl:variable name="HUD">

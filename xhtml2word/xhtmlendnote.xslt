...
<xsl:stylesheet version="2.0"
 ...
 <xsl:variable name="endnoteRootCount" select="count(//div[@style ='mso-element:endnote'])"/>
 <xsl:variable name="endnoteRootCount1" select="count(//li[@style ='mso-element:endnote'])"/>
 <xsl:variable name="endnoteRootCount2" select="count(//p[not(parent::li[@style ='mso-element:endnote'] or parent::div[@style ='mso-element:endnote'])][@style ='mso-element:endnote'])"/>
 ...
 <xsl:template match="/">
  ...
  <w:endnotes xmlns:wpc="http://schemas.microsoft.com/office/word/2010/wordprocessingCanvas"
   ...
   <xsl:if test="$endnoteRootCount > 1">
    <xsl:apply-templates select="//endnote|//div[@style='mso-element:endnote']/div|//div[@style='mso-element:endnote']"/> 
   </xsl:if>
   <xsl:if test="$endnoteRootCount = 1">
    <xsl:apply-templates select="//endnote|//div[@style='mso-element:endnote']"/>
   </xsl:if>
   <xsl:if test="$endnoteRootCount1 > 1"> 
    <xsl:apply-templates select="//endnote | //li[@style='mso-element:endnote']"/> 
   </xsl:if>
   <xsl:if test="$endnoteRootCount2 > 1">
    <xsl:apply-templates select="//endnote | //p[not(parent::li[@style='mso-element:endnote'])][@style='mso-element:endnote']"/> 
   </xsl:if> 
   </w:endnotes>
 </xsl:template>
 
 <xsl:template match="span[lower-case(@class) = 'endnotereference' or lower-case(@class) = 'EndnoteNumber']|span[lower-case(@class) ='msoendnotereference']"/>
 
 <xsl:template match="endnote|div[@style='mso-element:endnote']|div[@style='mso-element:endnote']/div | li[@style='mso-element:endnote']| p[not(parent::li[@style ='mso-element:endnote'] or parent::div[@style ='mso-element:endnote'])][@style='mso-element:endnote']">
  <!--<xsl:variable name="target" select="substring-after(descendant-or-self::*[starts-with(@href,'#eref')][1]/@href,'#')"/>-->
  <xsl:variable name="target" select="substring-after(descendant-or-self::*[contains(@class, 'endnotecitation')][@href][1]/@href,'#')"/>
  <xsl:variable name="isTargetPresent" select="boolean(preceding::*[@id = $target]|preceding::*[@name = $target])"/>
  ...
  <xsl:if test="$isTargetPresent = true() or $isTargetPresent1 = true()">
   <xsl:element name="w:endnote">
    <xsl:attribute name="w:id">
     <!--<xsl:value-of select="descendant::span[@class = 'endnoteReference'][1]"/>-->
     <xsl:number level="any" count="endnote | div[@style='mso-element:endnote']/div | div[@style='mso-element:endnote'] | li[@style='mso-element:endnote']| p[not(parent::li[@style ='mso-element:endnote'] or parent::div[@style ='mso-element:endnote'])][@style='mso-element:endnote']"/>
    </xsl:attribute>
    <!--<xsl:call-template name="infopath-rich-text"/>-->
     <xsl:choose>
     <xsl:when test="self::p[not(parent::li[@style ='mso-element:endnote'] or parent::div[@style ='mso-element:endnote'])][@style='mso-element:endnote']">
      <xsl:element name="w:p">
       <xsl:element name="w:pPr">
      ...
      <xsl:element name="w:r">
       <xsl:element name="w:rPr">
        <xsl:element name="w:rStyle">
         <xsl:attribute name="w:val" select="'EndnoteReference'"/>
        </xsl:element>
       </xsl:element>
       <xsl:element name="w:endnoteRef"/>
      </xsl:element>
  <xsl:call-template name="infopath-rich-text"/>
      </xsl:element>
     </xsl:when>
 ...
 -->
  ...
  <xsl:choose>
   <xsl:when test="descendant::h1|descendant::h2|descendant::h3|descendant::h4|descendant::h5|descendant::h6|descendant-or-self::p| descendant::li">
 ...
 <xsl:template  match="a[starts-with(@id, 'eref') or starts-with(@name, 'eref') or starts-with(@href,'#eref')]"/>
 <xsl:template  match="a[contains(@class, 'endnotecitation')][@id or @name or @href]"/>
 <xsl:template  match="a[contains(@class, 'crossref')][@href]"/>
 <xsl:template  match="a[not(contains(@class, 'endnotecitation'))][@href][parent::span[lower-case(@class)='endnotenumber']]"/>
 <!-- XHTML div -->
 <xsl:template match="h1|h2|h3|h4|h5|h6|p|li[not(@style='mso-element:endnote')]">
  <xsl:param name="pPr_Default"/>
  <xsl:param name="rPr_Default"/>
      ...
      <xsl:when test="$stylesCount > 1">
       ...
       <xsl:choose>
        <xsl:when test="string-length($styleId) > 0">
         <xsl:variable name="id" select="$styles//w:style[@w:styleId = $styleId][1]/@w:styleId"/>
         <xsl:choose>
...
<!-- <xsl:template match="annotation[string-length(@title) &gt; 0]|comment|img[@data-comment]">-->
 ...
 <xsl:template match="img[@data-comment|@data-commentimg][(ancestor::*[@data-change='commentdeleted'])]| span[@data-comment|@data-commentimg][(ancestor::*[@data-change='commentdeleted'])]"/>
 ...
 <!--commented on 15-02-2021-->
 <!--<xsl:template match="img[@data-comment|@data-commentimg][not(ancestor::*[@data-change='commentdeleted'])] | span[@data-comment|@data-commentimg][not(ancestor::*[@data-change='commentdeleted'])]">
...
<!--   <xsl:if test="not(child::tbody/colgroup)">-->
 ...
 <xsl:template match="td">
  ...
  <xsl:element name="w:tc">
   ...
   <xsl:choose>
    <xsl:when test="descendant::h1|descendant::h2|descendant::h3|descendant::h4|descendant::h5|descendant::h6|descendant::p| descendant::li">
     ...
     <xsl:if test="not(child::h1|child::h2|child::h3|child::h4|child::h5|child::h6|child::p| child::li)">
      <xsl:element name="w:p">
       <!--<xsl:apply-templates select="* | text()">
        <xsl:with-param name="pPr_Default"><xsl:copy-of select="$pPr_Default"/></xsl:with-param>
        <xsl:with-param name="rPr_Default"><xsl:copy-of select="$rPr_Default"/></xsl:with-param>
 ...
 <xsl:template match="img[@src][not(@data-comment|@data-commentimg)]">
  ...
  <xsl:choose>
   <xsl:when test="ancestor::h1|ancestor::h2|ancestor::h3|ancestor::h4|ancestor::h5|ancestor::h6|ancestor::p|ancestor::li">
    <xsl:element name="w:r">
     <xsl:element name="w:rPr">
     <!-- <xsl:call-template name="apply-nested-character-formatting">
       <xsl:with-param name="rPr_Default"><xsl:copy-of select="$rPr_Default"/></xsl:with-param>
 ...
 <xsl:template match="span[@style][not((lower-case(@class) ='msofootnotereference'))][not((lower-case(@class) ='endnotereference') or (lower-case(@class) ='EndnoteNumber'))]">
  <xsl:param name="pPr_Default"/>
  <xsl:param name="rPr_Default"/>
   <xsl:apply-templates>
    <xsl:with-param name="pPr_Default"><xsl:copy-of select="$pPr_Default"/></xsl:with-param>
...
<!--  <xsl:choose>-->
   <!--<xsl:if test="self::span[@data-bkmark = $name][count(./preceding::span[@data-bkmark = $name]) = 0]">
    <xsl:element name="w:bookmarkStart">
     <xsl:attribute name="w:id">
   ...
   <xsl:if test="self::span[@data-bkmark = $name][count(./following::span[@data-bkmark = $name]) = 0]">
    <xsl:element name="w:bookmarkEnd">
     <xsl:attribute name="w:id">
      <xsl:value-of select="//span[@data-bkmark = $name][count(./preceding::span[@data-bkmark = $name]) = 0]/@bkmarkID"/>
     </xsl:attribute>
    </xsl:element>
   </xsl:if>-->
  <!-- End -->
 ...
 <xsl:template match="*[@data-alias|@data-boxname|@data-boxtag|@data-id|@data-tag][not(self::p|self::li)]|a[@data-alias|@data-boxname|@data-boxtag|@data-id|@data-tag]">
...
<!-- soft enter-->
 ...
 <!-- XHTML hyperlink -->
<!-- a[@href and not(contains(@href,'#eref')) and not(contains(@class,'footnotecitation')) and not(ancestor-or-self::*[(lower-case(@class) ='endnotereference') or (lower-case(@class) ='EndnoteNumber')])][not(@data-alias|@data-boxname|@data-boxtag|@data-id|@data-tag)] -->
<xsl:template match="a[@href  and not(contains(@href,'#eref')) and not(contains(@class, 'endnotecitation')) and not(contains(@class, 'crossref')) and not(contains(@class,'footnotecitation')) and not(ancestor-or-self::*[(lower-case(@class) ='endnotereference') or (lower-case(@class) ='endnotenumber')])][not(@data-alias|@data-boxname|@data-boxtag|@data-id|@data-tag)]">

...
<!-- 07-Feb-18: The following when is only for "LUSTER" client -->
  ...
  <xsl:template match="spanX">
      ...
      <!--Ruta bibref 13-8-2019-->
      <!--<xsl:template match="a[child::span[contains(@class,'BibRef')]][preceding-sibling::*[1][self::span[normalize-space(.)='to' or 'To' or 'Through' or 'through' or '-' or '—' or '–']]][preceding-sibling::*[2][self::a[child::span[contains(@class,'BibRef')]]]]">
             <xsl:variable name="citaa">
                  <xsl:value-of select="self::a[child::span[contains(@class,'BibRef')]][preceding-sibling::*[1][self::span[normalize-space(.)='to' or 'To' or 'Through' or 'through' or '-' or '—' or '–']]]/preceding-sibling::*[2][self::a[child::span[contains(@class,'BibRef')]]]/."/>
            </xsl:variable>
            
            <xsl:variable name="cit">
                  <xsl:if test="number($citaa)">
                  <xsl:value-of select="$citaa + 1"/>
                  </xsl:if>
            </xsl:variable>
            
            <xsl:variable name="cit1a">
                  <xsl:value-of select="self::a/span[contains(@class,'BibRef')]/span/."/>
            </xsl:variable>
            
            <xsl:variable name="cit1">
                  <xsl:if test="number($cit1a)">
                  <xsl:value-of select="$cit1a - 1"/>
                  </xsl:if>
            </xsl:variable>
            
                 <xsl:variable name="href" select="self::a/substring-before(@href,'.xhtml')"/>       
            <!-\-<xsl:if test="string-length(self::a[child::span[contains(@class,'BibRef')]]/preceding-sibling::*[1][self::span[normalize-space(.)='to' or 'To' or 'Through' or 'through' or '-' or '—' or '–']]) > 0 and preceding-sibling::*[2][self::a[child::span[contains(@class,'BibRef')]]]">-\->
            
            <xsl:if test="string-length(self::a[child::span[contains(@class,'BibRef')]]/preceding-sibling::*[1][self::span[normalize-space(.)='to' or 'To' or 'Through' or 'through' or '-' or '—' or '–']]) > 0 and preceding-sibling::*[2][self::a[child::span[contains(@class,'BibRef')]]]">
             
                 
                  <xsl:for-each select="$cit to $cit1">
      ...
      <xsl:template match="span[contains(@data-alias,'to') or contains(@data-alias,'To') or contains(@data-alias,'Through') or contains(@data-alias,'through') or contains(@data-alias,'-') or contains(@data-alias,'—') or contains(@data-alias,'–')]/child::a[contains(@data-alias,'BibRef')][1]">
            ...
            <xsl:variable name="RVal" select="self::a[contains(@data-alias,'BibRef')]/parent::span[contains(@data-alias,'to') or contains(@data-alias,'To') or contains(@data-alias,'Through') or contains(@data-alias,'through') or contains(@data-alias,'-') or contains(@data-alias,'—') or contains(@data-alias,'–')]/@data-alias"/>
            ...
            <xsl:if test="self::a[contains(@data-alias,'BibRef')][parent::span[contains(@data-alias,'to') or contains(@data-alias,'To') or contains(@data-alias,'Through') or contains(@data-alias,'through') or contains(@data-alias,'-') or contains(@data-alias,'—') or contains(@data-alias,'–')]]">
                   ...
                   <xsl:variable name="href" select="self::a/substring-before(@href,'.xhtml')"/>
                  <xsl:analyze-string select="normalize-space($RVal)" regex="([\d]+)([-]?[—]?[–]?[to]?[To]?[Through]?[through]?)([\d]+)">

...
Rem XCOPY /Y \\10.1.1.100\automation\WORD2XML\W2HTML-CKeditor\02-Remove-xmlns.xslt
REN *.xml *.sgml
REM set CP=\\10.1.1.100\Automation\Saxon\saxon9.jar;
set CP=C:\saxon-he-9.3.0.5.jar;
rem set CP=\\D:\Saxon\saxon-he-9.3.0.5.jar;
rem set CP=\\D:\Saxon\Saxon-HE-9.7.0-8.jar;
rem set CP=\\C:\Saxon\Saxon-HE-10.3.jar;
CLS
...
java -cp %CP% net.sf.saxon.Transform -t -o:"%%~nf-out2.xml" -s:"%%~nf.xml" "01-W2H.xslt"
REM java -cp %CP% net.sf.saxon.Transform -o:"%%~nf-out2.xml" "%%~nf.xml" "01-W2H-Prasanth.xslt"
echo MAIN
rem pause
java -cp %CP% net.sf.saxon.Transform -o:"%%~nf-out3.xml" -s:"%%~nf-out2.xml" "02-Remove-xmlns.xslt" 
...
java -cp %CP% net.sf.saxon.Transform -o:"%%~nf-out4.xml" -s:"%%~nf-out3.xml" "1-LIST.xslt"
java -cp %CP% net.sf.saxon.Transform -o:"%%~nf-out5.xml" -s:"%%~nf-out4.xml" "2-LIST.xslt"
java -cp %CP% net.sf.saxon.Transform -o:"%%~nf-out6.xml" -s:"%%~nf-out5.xml" "3-LIST.xslt"
java -cp %CP% net.sf.saxon.Transform -o:"%%~nf-out7.xml" -s:"%%~nf-out6.xml" "35-LIST.xslt"
java -cp %CP% net.sf.saxon.Transform -o:"%%~nf-out8.xml" -s:"%%~nf-out7.xml" "4-LIST.xslt"
cls
echo list converted
rem pause

java -cp %CP% net.sf.saxon.Transform -o:"%%~nf.xhtml" -s:"%%~nf-out8.xml" "03-Final.xslt"

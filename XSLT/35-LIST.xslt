     ...
     <xsl:template match="GROUP">
           <xsl:choose>
                 <xsl:when test="preceding-sibling::*[1][self::GROUP] and following-sibling::*[1][self::GROUP]">
                       <xsl:choose>
                             <xsl:when test="child::one|child::two|child::three|child::four|child::five|child::six|child::seven">
                                   <!--<xsl:apply-templates select="node()"/>-->                                   
                                         <xsl:copy>
                                               <xsl:apply-templates select="@*|node()"/>
                                         </xsl:copy>                                   
                 ...
                 <xsl:when test="preceding-sibling::*[1][self::group]|preceding-sibling::*[1][self::GROUP]">
                       <!--<xsl:choose>
                 ...
                 <xsl:when test="following-sibling::*[1][self::group]|following-sibling::*[1][self::GROUP]">
                       <!--28-apr-17 <xsl:text disable-output-escaping="yes">&lt;GROUP&gt;</xsl:text>
                       <xsl:apply-templates select="@*|node()"/>-->
                       <!--<xsl:text disable-output-escaping="yes">&lt;GROUP&gt;</xsl:text>-->

            ...
            <xsl:choose>
                  ...
                  <xsl:when test="child::two">
                        <xsl:element name="GROUP">
                              ...
                              <xsl:attribute name="type" select="'dummy'"/>

<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:mf="http://example.com/mf" exclude-result-prefixes="xs mf" 
        ...
        <xsl:variable name="Na1">
            <xsl:choose>
                <xsl:when test="contains(@AppliedParagraphStyle,'$ID/')">
                    <xsl:value-of select="translate(substring-after(@AppliedParagraphStyle,'$ID/'),' /\[\]@#&lt;&gt;%','')"/>
                </xsl:when>
                ...
                <xsl:otherwise>
                    <xsl:value-of select="translate(@AppliedParagraphStyle,' /\[\]@#&lt;&gt;%','')"/>
                </xsl:otherwise>
            </xsl:choose>
        </xsl:variable>
             ...
             <xsl:choose>
                 <xsl:when test="$curParaNumLvl = '1' or $listlvl = '1'">                     
                     ...
                     <xsl:element name="one">
                         <xsl:if test="self::ParagraphStyleRange[descendant::XMLAttribute[contains(@Name,'data-isync')]]">
                             <xsl:for-each select="self::ParagraphStyleRange/descendant::XMLAttribute[contains(@Name,'data-isync')]">
                                 <xsl:variable name="att"><xsl:value-of select="@Name"/></xsl:variable>
                         ...
                         <xsl:attribute name="class" select="translate($Na1, ' /\[\]@','')"/>
                 ...
                 <xsl:otherwise>
                     <xsl:element name="p">
                         ...
                         <xsl:attribute name="class">
                             <xsl:value-of select="translate($Na1, ' /\[\]@','')"/>                             
                         </xsl:attribute>
                    ...
                    <xsl:element name="p">
                        ...
                        <xsl:attribute name="class">
                            ...
                            <xsl:choose>
                                ...
                                <xsl:when test="matches($Na1, '^[0-9]')">
                                    <xsl:value-of select="replace($Na1, '^([0-9]+)','')"/>
                                </xsl:when>
                                <xsl:otherwise>
                                    <!--<xsl:value-of select="$Na1"/>-->
                                    <xsl:choose>
    ...
    <xsl:template match="CharacterStyleRange">
        ...
        <xsl:variable name="Charstyle22">
            <xsl:choose>
                <xsl:when test="contains(@AppliedCharacterStyle,'$ID/')">
                    <xsl:value-of select="replace(substring-after(@AppliedCharacterStyle,'$ID/'),' ','')"/>
                </xsl:when>
                <xsl:when test="contains(@AppliedCharacterStyle,'CharacterStyle/')">
                    <xsl:value-of select="replace(substring-after(@AppliedCharacterStyle,'CharacterStyle/'),' ','')"/>
                </xsl:when>
                <xsl:otherwise>
                    <xsl:value-of select="replace(@AppliedCharacterStyle,' ','')"/>
                </xsl:otherwise>
            </xsl:choose>
        </xsl:variable>
                                    ...
                                    <xsl:otherwise>
                                        <xsl:choose>
                                            ...
                                            <xsl:when test="contains($Na22,'\')">
                                                <xsl:value-of select="replace($Na22,'\\','')"/>
                                            </xsl:when>
                                            <xsl:otherwise>
                ...
                <xsl:element name="span">
                    <xsl:choose>
                        <xsl:when test="@NestedAppliedCharacterStyle">
                            <xsl:attribute name="class">
                                <xsl:variable name="className" select="translate($Charstyle, ' /\[\]@#','')"/>
                                <xsl:variable name="className1" select="translate($NestedAppliedCharacterStyle, ' /\[\]@#','')"/>
                                <xsl:choose>
                                    ...
                                    <xsl:when test="matches($className, '^[0-9]')">
                                        <xsl:value-of select="replace($className, '^([0-9]+)','')"/>
                                    </xsl:when>
                                    <xsl:otherwise>
                                ...
                                <xsl:choose>
                                    ...
                                    <xsl:when test="matches($className1, '^[0-9]')">
                                        <xsl:value-of select="replace($className1, '^([0-9]+)','')"/>
                                    </xsl:when>
                                    <xsl:otherwise>
                    ...
                    <xsl:if test="self::CharacterStyleRange[contains(lower-case(substring-after(@AppliedCharacterStyle,'CharacterStyle/')),'sidebar-arrow')]">
                        <!-- sidebarparent -->
                        <xsl:attribute name="data-sidebarparent">
                            <xsl:value-of select="following-sibling::CharacterStyleRange[TextFrame]/child::TextFrame/@Story"/>
                        </xsl:attribute>
                        <!-- end -->
                    </xsl:if>
                    <!-- 21-JAN-19: GENERIC: Conditional Text informations by Bhaskar; called "designmap.xml" -->
    ...
    <xsl:template match="//Rectangle">  
        ...
        <xsl:choose>
            <xsl:when test="@Image">
                ...
                <!--</xsl:element>-->
                <!-- Math for on 26-09-2025 -->
                <xsl:if test="self::Rectangle/ancestor::ParagraphStyleRange/descendant::XMLElement[@MarkupTag='XMLTag/figure'][descendant::XMLAttribute[@Name='depth' or @Name='height' or @Name='totalheight' or @Name='width']][descendant::XMLAttribute[contains(@Name,'href')][contains(@Value,'/Links')]/tokenize(@Value, '/+')[last()]=$IMG or descendant::XMLAttribute[contains(@Name,'href')][contains(@Value,'/Links')]/@Value=$IMG]">
                    <xsl:variable name="eqName">
                        <xsl:choose>
                            <xsl:when test="self::Rectangle/ancestor::ParagraphStyleRange/descendant::XMLElement[@MarkupTag='XMLTag/figure'][descendant::XMLAttribute[@Name='depth' or @Name='height' or @Name='totalheight' or @Name='width']][descendant::XMLAttribute[contains(@Name,'href')][contains(@Value,'/Links')]/tokenize(@Value, '/+')[last()]=$IMG]">
                                <xsl:value-of select="self::Rectangle/ancestor::ParagraphStyleRange/descendant::XMLElement[@MarkupTag='XMLTag/figure'][descendant::XMLAttribute[@Name='depth' or @Name='height' or @Name='totalheight' or @Name='width']][descendant::XMLAttribute[contains(@Name,'href')][contains(@Value,'/Links')]/tokenize(@Value, '/+')[last()]=$IMG]/descendant::XMLAttribute[contains(@Name,'href')][contains(@Value,'/Links')]/tokenize(@Value, '/+')[last()]"/>
                            </xsl:when>
                            <xsl:otherwise>
                                <xsl:value-of select="self::Rectangle/ancestor::ParagraphStyleRange/descendant::XMLElement[@MarkupTag='XMLTag/figure'][descendant::XMLAttribute[@Name='depth' or @Name='height' or @Name='totalheight' or @Name='width']][descendant::XMLAttribute[contains(@Name,'href')][contains(@Value,'/Links')]/@Value=$IMG]/descendant::XMLAttribute[contains(@Name,'href')][contains(@Value,'/Links')]/@Value"/>
                            </xsl:otherwise>
                        </xsl:choose>
                    </xsl:variable>
                    <xsl:element name="span">
                        <xsl:choose>
                            <xsl:when test="ancestor::ParagraphStyleRange[1]/descendant::Content[string-length(.) &gt; 0]">
                                <xsl:attribute name="data-mathinline" select="'true'"/>
                            </xsl:when>
                            <xsl:otherwise>
                                <xsl:attribute name="data-mathdisplay" select="'true'"/>
                            </xsl:otherwise>
                        </xsl:choose>
                        <xsl:attribute name="id" select="'mathjax'"/>
                        <xsl:attribute name="contenteditable" select="'false'"/>
                        <xsl:attribute name="class" select="'math-content'"/>
                        <xsl:attribute name="depth"><xsl:value-of select="self::Rectangle/ancestor::ParagraphStyleRange/descendant::XMLElement[@MarkupTag='XMLTag/figure'][descendant::XMLAttribute[@Name='depth' or @Name='height' or @Name='totalheight' or @Name='width']][descendant::XMLAttribute[contains(@Name,'href')][contains(@Value,'/Links')]/tokenize(@Value, '/+')[last()]=$IMG or descendant::XMLAttribute[contains(@Name,'href')][contains(@Value,'/Links')]/@Value=$IMG]/descendant::XMLAttribute[@Name='depth']/@Value"/></xsl:attribute>
                        <xsl:attribute name="height"><xsl:value-of select="self::Rectangle/ancestor::ParagraphStyleRange/descendant::XMLElement[@MarkupTag='XMLTag/figure'][descendant::XMLAttribute[@Name='depth' or @Name='height' or @Name='totalheight' or @Name='width']][descendant::XMLAttribute[contains(@Name,'href')][contains(@Value,'/Links')]/tokenize(@Value, '/+')[last()]=$IMG or descendant::XMLAttribute[contains(@Name,'href')][contains(@Value,'/Links')]/@Value=$IMG]/descendant::XMLAttribute[@Name='height']/@Value"/></xsl:attribute>
                        <xsl:attribute name="totalheight"><xsl:value-of select="self::Rectangle/ancestor::ParagraphStyleRange/descendant::XMLElement[@MarkupTag='XMLTag/figure'][descendant::XMLAttribute[@Name='depth' or @Name='height' or @Name='totalheight' or @Name='width']][descendant::XMLAttribute[contains(@Name,'href')][contains(@Value,'/Links')]/tokenize(@Value, '/+')[last()]=$IMG or descendant::XMLAttribute[contains(@Name,'href')][contains(@Value,'/Links')]/@Value=$IMG]/descendant::XMLAttribute[@Name='totalheight']/@Value"/></xsl:attribute>
                        <xsl:attribute name="width"><xsl:value-of select="self::Rectangle/ancestor::ParagraphStyleRange/descendant::XMLElement[@MarkupTag='XMLTag/figure'][descendant::XMLAttribute[@Name='depth' or @Name='height' or @Name='totalheight' or @Name='width']][descendant::XMLAttribute[contains(@Name,'href')][contains(@Value,'/Links')]/tokenize(@Value, '/+')[last()]=$IMG or descendant::XMLAttribute[contains(@Name,'href')][contains(@Value,'/Links')]/@Value=$IMG]/descendant::XMLAttribute[@Name='width']/@Value"/></xsl:attribute>
                        <xsl:attribute name="latex"><xsl:value-of select="self::Rectangle/ancestor::ParagraphStyleRange/descendant::XMLElement[@MarkupTag='XMLTag/figure'][descendant::XMLAttribute[@Name='depth' or @Name='height' or @Name='totalheight' or @Name='width']][descendant::XMLAttribute[contains(@Name,'href')][contains(@Value,'/Links')]/tokenize(@Value, '/+')[last()]=$IMG or descendant::XMLAttribute[contains(@Name,'href')][contains(@Value,'/Links')]/@Value=$IMG]/descendant::XMLAttribute[@Name='latex']/@Value"/></xsl:attribute>
                        <xsl:attribute name="data-fileName"><xsl:value-of select="$eqName"/></xsl:attribute>
                    </xsl:element>
                </xsl:if>
                <!-- added for image name matched with next paragraph  on 29-9-2025-->
                <xsl:if test="self::Rectangle/ancestor::ParagraphStyleRange/following-sibling::ParagraphStyleRange/descendant::XMLElement[@MarkupTag='XMLTag/figure'][descendant::XMLAttribute[@Name='depth' or @Name='height' or @Name='totalheight' or @Name='width']][descendant::XMLAttribute[contains(@Name,'href')][contains(@Value,'/Links')]/tokenize(@Value, '/+')[last()]=$IMG or descendant::XMLAttribute[contains(@Name,'href')][contains(@Value,'/Links')]/@Value=$IMG]">
                    
                    <xsl:variable name="eqName1">
                        <xsl:choose>
                            <xsl:when test="self::Rectangle/ancestor::ParagraphStyleRange/following-sibling::ParagraphStyleRange/descendant::XMLElement[@MarkupTag='XMLTag/figure'][descendant::XMLAttribute[@Name='depth' or @Name='height' or @Name='totalheight' or @Name='width']][descendant::XMLAttribute[contains(@Name,'href')][contains(@Value,'/Links')]/tokenize(@Value, '/+')[last()]=$IMG]">
                                <xsl:value-of select="self::Rectangle/ancestor::ParagraphStyleRange/following-sibling::ParagraphStyleRange/descendant::XMLElement[@MarkupTag='XMLTag/figure'][descendant::XMLAttribute[@Name='depth' or @Name='height' or @Name='totalheight' or @Name='width']][descendant::XMLAttribute[contains(@Name,'href')][contains(@Value,'/Links')]/tokenize(@Value, '/+')[last()]=$IMG]/descendant::XMLAttribute[contains(@Name,'href')][contains(@Value,'/Links')]/tokenize(@Value, '/+')[last()]"/>
                            </xsl:when>
                            <xsl:otherwise>
                                <xsl:value-of select="self::Rectangle/ancestor::ParagraphStyleRange/following-sibling::ParagraphStyleRange/descendant::XMLElement[@MarkupTag='XMLTag/figure'][descendant::XMLAttribute[@Name='depth' or @Name='height' or @Name='totalheight' or @Name='width']][descendant::XMLAttribute[contains(@Name,'href')][contains(@Value,'/Links')]/@Value=$IMG]/descendant::XMLAttribute[contains(@Name,'href')][contains(@Value,'/Links')]/@Value"/>
                            </xsl:otherwise>
                        </xsl:choose>
                    </xsl:variable>
                    <xsl:element name="span">
                        ...
                        <xsl:attribute name="contenteditable" select="'false'"/>
                        <xsl:attribute name="class" select="'math-content'"/>
                        <xsl:attribute name="depth"><xsl:value-of select="self::Rectangle/ancestor::ParagraphStyleRange/following-sibling::ParagraphStyleRange/descendant::XMLElement[@MarkupTag='XMLTag/figure'][descendant::XMLAttribute[@Name='depth' or @Name='height' or @Name='totalheight' or @Name='width']][descendant::XMLAttribute[contains(@Name,'href')][contains(@Value,'/Links')]/tokenize(@Value, '/+')[last()]=$IMG or descendant::XMLAttribute[contains(@Name,'href')][contains(@Value,'/Links')]/@Value=$IMG]/descendant::XMLAttribute[@Name='depth']/@Value"/></xsl:attribute>
                        <xsl:attribute name="height"><xsl:value-of select="self::Rectangle/ancestor::ParagraphStyleRange/following-sibling::ParagraphStyleRange/descendant::XMLElement[@MarkupTag='XMLTag/figure'][descendant::XMLAttribute[@Name='depth' or @Name='height' or @Name='totalheight' or @Name='width']][descendant::XMLAttribute[contains(@Name,'href')][contains(@Value,'/Links')]/tokenize(@Value, '/+')[last()]=$IMG or descendant::XMLAttribute[contains(@Name,'href')][contains(@Value,'/Links')]/@Value=$IMG]/descendant::XMLAttribute[@Name='height']/@Value"/></xsl:attribute>
                        <xsl:attribute name="totalheight"><xsl:value-of select="self::Rectangle/ancestor::ParagraphStyleRange/following-sibling::ParagraphStyleRange/descendant::XMLElement[@MarkupTag='XMLTag/figure'][descendant::XMLAttribute[@Name='depth' or @Name='height' or @Name='totalheight' or @Name='width']][descendant::XMLAttribute[contains(@Name,'href')][contains(@Value,'/Links')]/tokenize(@Value, '/+')[last()]=$IMG or descendant::XMLAttribute[contains(@Name,'href')][contains(@Value,'/Links')]/@Value=$IMG]/descendant::XMLAttribute[@Name='totalheight']/@Value"/></xsl:attribute>
                        <xsl:attribute name="width"><xsl:value-of select="self::Rectangle/ancestor::ParagraphStyleRange/following-sibling::ParagraphStyleRange/descendant::XMLElement[@MarkupTag='XMLTag/figure'][descendant::XMLAttribute[@Name='depth' or @Name='height' or @Name='totalheight' or @Name='width']][descendant::XMLAttribute[contains(@Name,'href')][contains(@Value,'/Links')]/tokenize(@Value, '/+')[last()]=$IMG or descendant::XMLAttribute[contains(@Name,'href')][contains(@Value,'/Links')]/@Value=$IMG]/descendant::XMLAttribute[@Name='width']/@Value"/></xsl:attribute>
                        <xsl:attribute name="latex"><xsl:value-of select="self::Rectangle/ancestor::ParagraphStyleRange/following-sibling::ParagraphStyleRange/descendant::XMLElement[@MarkupTag='XMLTag/figure'][descendant::XMLAttribute[@Name='depth' or @Name='height' or @Name='totalheight' or @Name='width']][descendant::XMLAttribute[contains(@Name,'href')][contains(@Value,'/Links')]/tokenize(@Value, '/+')[last()]=$IMG or descendant::XMLAttribute[contains(@Name,'href')][contains(@Value,'/Links')]/@Value=$IMG]/descendant::XMLAttribute[@Name='latex']/@Value"/></xsl:attribute>
                        <xsl:attribute name="data-fileName"><xsl:value-of select="$eqName1"/></xsl:attribute>
                    </xsl:element>
                </xsl:if>
                
                <xsl:if test="self::Rectangle/ancestor::ParagraphStyleRange/preceding-sibling::ParagraphStyleRange/descendant::XMLElement[@MarkupTag='XMLTag/figure'][descendant::XMLAttribute[@Name='depth' or @Name='height' or @Name='totalheight' or @Name='width']][descendant::XMLAttribute[contains(@Name,'href')][contains(@Value,'/Links')]/tokenize(@Value, '/+')[last()]=$IMG or descendant::XMLAttribute[contains(@Name,'href')][contains(@Value,'/Links')]/@Value=$IMG]">
                    
                    <xsl:variable name="eqName1">
                        <xsl:choose>
                            <xsl:when test="self::Rectangle/ancestor::ParagraphStyleRange/preceding-sibling::ParagraphStyleRange/descendant::XMLElement[@MarkupTag='XMLTag/figure'][descendant::XMLAttribute[@Name='depth' or @Name='height' or @Name='totalheight' or @Name='width']][descendant::XMLAttribute[contains(@Name,'href')][contains(@Value,'/Links')]/tokenize(@Value, '/+')[last()]=$IMG]">
                                <xsl:value-of select="self::Rectangle/ancestor::ParagraphStyleRange/preceding-sibling::ParagraphStyleRange/descendant::XMLElement[@MarkupTag='XMLTag/figure'][descendant::XMLAttribute[@Name='depth' or @Name='height' or @Name='totalheight' or @Name='width']][descendant::XMLAttribute[contains(@Name,'href')][contains(@Value,'/Links')]/tokenize(@Value, '/+')[last()]=$IMG]/descendant::XMLAttribute[contains(@Name,'href')][contains(@Value,'/Links')]/tokenize(@Value, '/+')[last()]"/>
                            </xsl:when>
                            <xsl:otherwise>
                                <xsl:value-of select="self::Rectangle/ancestor::ParagraphStyleRange/preceding-sibling::ParagraphStyleRange/descendant::XMLElement[@MarkupTag='XMLTag/figure'][descendant::XMLAttribute[@Name='depth' or @Name='height' or @Name='totalheight' or @Name='width']][descendant::XMLAttribute[contains(@Name,'href')][contains(@Value,'/Links')]/@Value=$IMG]/descendant::XMLAttribute[contains(@Name,'href')][contains(@Value,'/Links')]/@Value"/>
                            </xsl:otherwise>
                        </xsl:choose>
                    </xsl:variable>
                    <xsl:element name="span">
                        ...
                        <xsl:attribute name="contenteditable" select="'false'"/>
                        <xsl:attribute name="class" select="'math-content'"/>
                        <xsl:attribute name="depth"><xsl:value-of select="self::Rectangle/ancestor::ParagraphStyleRange/preceding-sibling::ParagraphStyleRange/descendant::XMLElement[@MarkupTag='XMLTag/figure'][descendant::XMLAttribute[@Name='depth' or @Name='height' or @Name='totalheight' or @Name='width']][descendant::XMLAttribute[contains(@Name,'href')][contains(@Value,'/Links')]/tokenize(@Value, '/+')[last()]=$IMG or descendant::XMLAttribute[contains(@Name,'href')][contains(@Value,'/Links')]/@Value=$IMG]/descendant::XMLAttribute[@Name='depth']/@Value"/></xsl:attribute>
                        <xsl:attribute name="height"><xsl:value-of select="self::Rectangle/ancestor::ParagraphStyleRange/preceding-sibling::ParagraphStyleRange/descendant::XMLElement[@MarkupTag='XMLTag/figure'][descendant::XMLAttribute[@Name='depth' or @Name='height' or @Name='totalheight' or @Name='width']][descendant::XMLAttribute[contains(@Name,'href')][contains(@Value,'/Links')]/tokenize(@Value, '/+')[last()]=$IMG or descendant::XMLAttribute[contains(@Name,'href')][contains(@Value,'/Links')]/@Value=$IMG]/descendant::XMLAttribute[@Name='height']/@Value"/></xsl:attribute>
                        <xsl:attribute name="totalheight"><xsl:value-of select="self::Rectangle/ancestor::ParagraphStyleRange/preceding-sibling::ParagraphStyleRange/descendant::XMLElement[@MarkupTag='XMLTag/figure'][descendant::XMLAttribute[@Name='depth' or @Name='height' or @Name='totalheight' or @Name='width']][descendant::XMLAttribute[contains(@Name,'href')][contains(@Value,'/Links')]/tokenize(@Value, '/+')[last()]=$IMG or descendant::XMLAttribute[contains(@Name,'href')][contains(@Value,'/Links')]/@Value=$IMG]/descendant::XMLAttribute[@Name='totalheight']/@Value"/></xsl:attribute>
                        <xsl:attribute name="width"><xsl:value-of select="self::Rectangle/ancestor::ParagraphStyleRange/preceding-sibling::ParagraphStyleRange/descendant::XMLElement[@MarkupTag='XMLTag/figure'][descendant::XMLAttribute[@Name='depth' or @Name='height' or @Name='totalheight' or @Name='width']][descendant::XMLAttribute[contains(@Name,'href')][contains(@Value,'/Links')]/tokenize(@Value, '/+')[last()]=$IMG or descendant::XMLAttribute[contains(@Name,'href')][contains(@Value,'/Links')]/@Value=$IMG]/descendant::XMLAttribute[@Name='width']/@Value"/></xsl:attribute>
                        <xsl:attribute name="latex"><xsl:value-of select="self::Rectangle/ancestor::ParagraphStyleRange/preceding-sibling::ParagraphStyleRange/descendant::XMLElement[@MarkupTag='XMLTag/figure'][descendant::XMLAttribute[@Name='depth' or @Name='height' or @Name='totalheight' or @Name='width']][descendant::XMLAttribute[contains(@Name,'href')][contains(@Value,'/Links')]/tokenize(@Value, '/+')[last()]=$IMG or descendant::XMLAttribute[contains(@Name,'href')][contains(@Value,'/Links')]/@Value=$IMG]/descendant::XMLAttribute[@Name='latex']/@Value"/></xsl:attribute>
                        <xsl:attribute name="data-fileName"><xsl:value-of select="$eqName1"/></xsl:attribute>
                    </xsl:element>
                </xsl:if>
                <!-- end -->

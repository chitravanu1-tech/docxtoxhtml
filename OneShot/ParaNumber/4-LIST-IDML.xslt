...
<xsl:output method="xml" omit-xml-declaration="no" indent="no" cdata-section-elements="alt"/>
      ...
      <xsl:template match="group|GROUP">
            <xsl:choose>
                  <xsl:when test="child::*[1]">
                        ...
                        <xsl:choose>
                              <xsl:when test="contains($type, 'dummy')">
                                    <xsl:element name="ul">
                              ...
                              <xsl:when test="contains($numberType, 'BULLET_LIST')">
                                    <xsl:element name="ul">
                                          <xsl:copy-of select="child::*[1]/@*"/>
                                          <xsl:attribute name="type" select="$numberFormat"/>
                                          <xsl:attribute name="class"> 
                                                <xsl:choose>
                                                      ...
                                                      <xsl:when test="contains(@start, '(') and contains(@start, ')')">
                                                            <xsl:text>opencloseParen</xsl:text>
                                                      </xsl:when>
                                                      ...
                                                      <xsl:when test="contains(child::*[1][self::node()]/@start, '(') and contains(child::*[1][self::node()]/@start, ')')">
                                                            <xsl:text>opencloseParen</xsl:text>
                                                      </xsl:when>
                                                      <xsl:when test="contains(child::*[1][self::node()]/@start, '(')">
                                                            <xsl:text>openParen</xsl:text>
                                                      </xsl:when>                      
                                                      <xsl:when test="contains(child::*[1][self::node()]/@start, ')')">
                                                            <xsl:text>closeParen</xsl:text>
                              ...
                              <xsl:when test="contains($numberFormat, '1')">
                                    <xsl:element name="ol">
                                          <xsl:copy-of select="child::*[1]/@*"/>
                                          ...
                                          <xsl:attribute name="class"> 
                                                <!--<xsl:message><xsl:value-of select="@start"></xsl:value-of></xsl:message>-->
                                                <xsl:choose>
                                                      ...
                                                      <xsl:when test="contains(child::*[1][self::node()]/@start, 'Step')">
                                          ...
                                          <xsl:attribute name="start">
                                                <xsl:choose>
                                                      <xsl:when test="contains(child::*[1]/@start, 'Step')">
                                                            <xsl:value-of select="substring-after(translate(substring-before(child::*[1]/@start, ':'),'()[]',''),' ')"/>
                                                      </xsl:when>
                                                      <xsl:when test="contains(child::*[1]/@start, '.&#x9;')">
                                                            <xsl:value-of select="translate(substring-before(child::*[1]/@start, '.&#x9;'),'()[]','')"/>
                                                      </xsl:when>
                                                      <xsl:when test="contains(child::*[1]/@start, '. ')">
                                                            <xsl:value-of select="translate(substring-before(child::*[1]/@start, '. '),'()[]','')"/>
                                                      </xsl:when>
                                                      ...
                                                      <xsl:otherwise>
                                                            <xsl:value-of select="translate(child::*[1]/@start, '()[]', '')"/>
                                                      </xsl:otherwise>
                                                </xsl:choose>                                                
                                          </xsl:attribute>
                              ...
                              <xsl:when test="contains($numberFormat, 'a')">
                                    <xsl:element name="ol">
                                          <xsl:copy-of select="child::*[1]/@*"/>
                                          <xsl:attribute name="type">
                                                <xsl:choose>
                              ...
                              <xsl:when test="contains($numberFormat, 'i')">
                                    <xsl:element name="ol">
                                          <xsl:copy-of select="child::*[1]/@*"/>
                                          <xsl:attribute name="type">
                                                <xsl:choose>
                              ...
                              <xsl:when test="contains($numberType, 'decimal')">
                                    <xsl:element name="ol">
                                          <xsl:copy-of select="child::*[1]/@*"/>
                                          <xsl:attribute name="type">
                                                <xsl:choose>
                                          ...
                                          <xsl:attribute name="start">
                                                <xsl:choose>
                                                      <xsl:when test="contains(child::*[1]/@start, '.&#x9;')">
                                                            <xsl:value-of select="substring-before(child::*[1]/@start, '.&#x9;')"></xsl:value-of>
                                                      </xsl:when>
                                                      <xsl:when test="contains(child::*[1]/@start, '. ')">
                                                            <xsl:value-of select="substring-before(child::*[1]/@start, '. ')"></xsl:value-of>
                                                      </xsl:when>
                              ...
                              <xsl:when test="contains($numberType, 'lowerLetter')">
                                    <xsl:element name="ol">
                                          <xsl:copy-of select="child::*[1]/@*"/>
                                          <xsl:attribute name="type">
                                                <xsl:choose>
                              ...
                              <xsl:when test="contains($numberType, 'upperLetter')">
                                    <xsl:element name="ol">
                                          <xsl:copy-of select="child::*[1]/@*"/>
                                          <xsl:attribute name="type">
                                                            <xsl:value-of select="'A'"/>
                              ...
                              <xsl:when test="contains($numberType, 'lowerRoman')">
                                    <xsl:element name="ol">
                                          <xsl:copy-of select="child::*[1]/@*"/>
                                          <xsl:attribute name="type">
                                                <xsl:choose>
                              ...
                              <xsl:when test="contains($numberType, 'upperRoman')">
                                    <xsl:element name="ol">
                                          <xsl:copy-of select="child::*[1]/@*"/>
                                          <xsl:attribute name="type">
                                                <xsl:choose>
                              ...
                              <xsl:when test="contains($listType, 'BULLET_LIST')">
                                    <xsl:element name="ol">
                                          <xsl:copy-of select="child::*[1]/@*"/>
      ...
      <xsl:template match="one|two|three|four|five|six|seven|eight|nine|ten">
            <xsl:if test="not(@type = 'dummy')"> <!-- xsl:if test="not(@listtype = 'dummy') -->
                  <xsl:element name="li">

...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:mf="http://example.com/mf" exclude-result-prefixes="xs mf" 
    ...
    <xsl:template match="document">
        <w:document xmlns:wpc="http://schemas.microsoft.com/office/word/2010/wordprocessingCanvas"
            ...
            <xsl:namespace name="m" select="'http://schemas.openxmlformats.org/officeDocument/2006/math'"/>
            <xsl:namespace name="v" select="'urn:schemas-microsoft-com:vml'"/> 
            <xsl:namespace name="wp" select="'http://schemas.openxmlformats.org/drawingml/2006/wordprocessingDrawing'"/> 
            ...
            <xsl:namespace name="w14" select="'http://schemas.microsoft.com/office/word/2010/wordml'"/> 
            <xsl:namespace name="wpg" select="'http://schemas.microsoft.com/office/word/2010/wordprocessingGroup'"/> 
            <xsl:namespace name="wpi" select="'http://schemas.microsoft.com/office/word/2010/wordprocessingInk'"/> 
            <xsl:namespace name="wne" select="'http://schemas.microsoft.com/office/word/2006/wordml'"/> 
            <xsl:namespace name="wps" select="'http://schemas.microsoft.com/office/word/2010/wordprocessingShape'"/>
        ...
        <!-- creating the settings.xml based on the document -->
        <xsl:choose>
            <xsl:when test="descendant::w:permStart and descendant::w:permEnd">
                <xsl:result-document href="settings.xml" format="xml">
                    <w:settings xmlns:mc="http://schemas.openxmlformats.org/markup-compatibility/2006" xmlns:o="urn:schemas-microsoft-com:office:office" xmlns:r="http://schemas.openxmlformats.org/officeDocument/2006/relationships" xmlns:m="http://schemas.openxmlformats.org/officeDocument/2006/math" xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w10="urn:schemas-microsoft-com:office:word" xmlns:w="http://schemas.openxmlformats.org/wordprocessingml/2006/main" xmlns:w14="http://schemas.microsoft.com/office/word/2010/wordml" xmlns:w15="http://schemas.microsoft.com/office/word/2012/wordml" xmlns:sl="http://schemas.openxmlformats.org/schemaLibrary/2006/main" mc:Ignorable="w14 w15">
                        ...
                        <w:linkStyles/>
                        <w:trackRevisions/>
                        <w:documentProtection w:edit="readOnly" w:enforcement="1" w:cryptProviderType="rsaAES" w:cryptAlgorithmClass="hash" w:cryptAlgorithmType="typeAny" w:cryptAlgorithmSid="14" w:cryptSpinCount="100000" w:hash="9SBbcnrxSL0DC0tUl8wnfXfWSqCR930b+IJFhGScLFgv3IKhVwp6fAyJk5VAqyNTX+nQVShZKsyCEDSQKti8dQ==" w:salt="VZ5sNS8ix5h3iA+VErlb4Q=="/>
            ...
            <xsl:otherwise>
                <xsl:result-document href="settings.xml" format="xml">
                    <w:settings xmlns:mc="http://schemas.openxmlformats.org/markup-compatibility/2006"
                        ...
                        <w:linkStyles/>
                        <w:trackRevisions/>
                        <w:documentProtection w:edit="trackedChanges" w:enforcement="1" w:cryptProviderType="rsaFull"
                            w:cryptAlgorithmClass="hash" w:cryptAlgorithmType="typeAny" w:cryptAlgorithmSid="4"
                            w:cryptSpinCount="100000" w:hash="ofiT3yhNpjL3GDz79vo0pWQvEn4="
                            w:salt="DADozrzfivduBydekZMPkw=="/>
                        <w:defaultTabStop w:val="720"/>
                        <w:characterSpacingControl w:val="doNotCompress"/>
                        <w:compat>

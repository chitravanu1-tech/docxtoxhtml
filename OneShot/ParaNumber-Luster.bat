...
pause
java -cp %CP% net.sf.saxon.Transform -o:"%~dp0\ParaNumber\textInpSorting.xml" "%~dp0\ParaNumber\textInp.xml" "%~dp0\ParaNumber\textInpSorting-Luster.xslt"
echo now check the sort**********************
pause
...
echo before 04-FINAL completed
pause
